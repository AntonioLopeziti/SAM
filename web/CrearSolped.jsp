...
<html>
    ...
    <%
        ...
        String ERCuenM = po.getProperty("etiqueta.CSPCMayNoValid");
        String ERCCost = po.getProperty("etiqueta.CSPCCostoNovali");
        String ERORD = po.getProperty("etiqueta.CSPNotOrden");
        ...
        String DocumeCon = po.getProperty("etiqueta.CSPDocumentoCont");
        String DocumeConEr = po.getProperty("etiqueta.CSPDocumentoContErr");
        String tiposer = po.getProperty("etiqueta.CSPObTposSer");
        String Serinva = po.getProperty("etiqueta.CSPServInval");
        String Sering = po.getProperty("etiqueta.CSPServUnda");
        String SerCan = po.getProperty("etiqueta.CSPServCan");
        String Serprec = po.getProperty("etiqueta.CSPServPrec");
        String Serdesser = po.getProperty("etiqueta.CSPServDes");
        String Serdel = po.getProperty("etiqueta.CSPServDel");
        ...
        String CSPDocobg = po.getProperty("etiqueta.CSPDocobg");
...
<!--                            <option value="NC"><%out.println(po.getProperty("etiqueta.CSPCSOLPEDOF"));%></option>-->
                        </select>
                        <hr>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.CSPNumNecesidad"));%></label><input onpaste="return false" type="text" id="necesidad" style="width: 25%;" disabled/>
                    </section>
                    <section class="SecD">
                ...
                <div class="divImputacion" id="divimppp">
                    <label><%out.println(po.getProperty("etiqueta.CSPTituloImputacion"));%></label>
                    <hr id="LineSC">
                    <div class="divTipos">
                        <div class="tip1">
                            <label><%out.println(po.getProperty("etiqueta.CSPTituloImputacion2"));%></label><select id="TipoImputacion" style="width:17%;"></select>
                            <hr>
                        </div>
                        <div class="tip2">
                            <label><%out.println(po.getProperty("etiqueta.CSPTipoPosición2"));%></label><select id="TipoPosicion" style="width:17%;"></select>
                            <hr>
                        </div>
                        <div class="tip3">
                    ...
                    <div class="divimpsol">
                        <div class="inp1">
                            <label><%out.println(po.getProperty("etiqueta.CSPMaterial"));%></label><input type="text" id="Material" maxlength="18"  style="width:35%; background-repeat: no-repeat; text-transform: uppercase;"/><button id="matchMaterial" class='BtnMatchIcon2'></button>
                            <hr>
                    ...
                    <div class="subimputacion">
                        ...
                        <hr id="LineSubIm">
                        <div class="subinn1">
                            <label><%out.println(po.getProperty("etiqueta.CSPCMayor"));%></label><input type="text" id="ctaMayor"  maxlength="10" onpaste="return false" style="width: 40%; background-repeat: no-repeat;"/><button id="matchCtaMayor" class="BtnMatchIcon2"></button>
                            <hr>
                        </div>
                        <div class="subinn2">
                            <label><%out.println(po.getProperty("etiqueta.CSPCCosto"));%></label><input type="text" id="CenCosto"  maxlength="10" onpaste="return false" style="width: 40%; text-transform: uppercase; background-repeat: no-repeat"/><button id="matchCCosto" class="BtnMatchIcon2"></button>
                            <hr>
                        </div>
                        <div class="subinn3">
                            <label><%out.println(po.getProperty("etiqueta.CSPOrden"));%></label><input type="text"  maxlength="12"  id="Orde" style="width: 30%; background-repeat: no-repeat; text-transform: uppercase;"/><button id="matchOrden" class="BtnMatchIcon2"></button> / <input type="text" style="width:30%; background: none; border: none;" readOnly id="OrdSAM"/>
                            <hr>
                        </div>
                    </div>
                </div>
            ...
            <div class="ServiceGral">
                <div class="ServDatoPso">
                    ...
                    <div class="Serv1">
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.CSPFechEnt"));%></label><input type="text" id="FentregaSer" maxlength="10" readOnly style="width: 30%;"/>
                        <hr>
                    ...
                    <div class="table-scroll" id="table-scrollGCompras">
                        <div class="fixedY" id="fixedYGCompras">
                            <table>
                                <thead> 
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.CSPGrpoCompras")
                                            );%></th><th><%out.println(po.
                                                        getProperty("etiqueta.CSPDenGCompras"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                    ...
                    <div class="table-scrollM" id="table-scrollMaterial">
                        <div class="fixedYM" id="fixedYMaterial">
                            <table>
                                <thead>
                                    <tr>
                                            <th><%out.println(po.getProperty("etiqueta.CSPMaterial"));%></th><th><%out.println(po.
                                                        getProperty("etiqueta.CSPTextoBrveMaterial")
                                                );%></th><th><%out.println(po.
                                                                                                    getProperty("etiqueta.CSPCentro"));%></th><th><%out.println(po.
                                                                                                                    getProperty("etiqueta.CPSMateriaTipo"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                    ...
                    <div class="table-scroll" id="table-scrollCentro">
                        <div class="fixedY" id="fixedYCentro">
                            <table>
                                <thead>
                                    <tr>
                                            <th><%out.println(po.getProperty("etiqueta.CSPCentro"));%></th><th><%out.println(po.
                                                        getProperty("etiqueta.CSPNombre"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <div id="VentanaModalAlmacen" class="VentanaModal">
            ...
            <div id="BuscarParamAlmacen_SP" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.CSPAlmac"));%></label><input type="text" id="BusAlmacen" style="width:35%; text-transform: uppercase;"/>
                        <hr>
                    ...
                    <div class="table-scroll" id="table-scrollAlmacen">
                        <div class="fixedY" id="fixedYAlmacen">
                            <table>
                                <thead>
                                    <tr>
                                            <th><%out.println(po.getProperty("etiqueta.CSPAlmacen"));%></th><th><%out.println(po.
                                                        getProperty("etiqueta.CSPDenAlm"));%></th><th><%out.println(po.
                                                                getProperty("etiqueta.CSPCentro"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                    ...
                    <div class="table-scroll" id="table-scrollUM">
                        <div class="fixedY" id="fixedYUM">
                            <table>
                                <thead>
                                    <tr>
                                            <th><%out.println(po.getProperty("etiqueta.CSPUnidadMedida"));%></th><th><%out.println(po.
                                                        getProperty("etiqueta.CSPUMTexto"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                    ...
                    <div class="table-scroll" id="table-scrollGArticulos">
                        <div class="fixedY" id="fixedYGArticulos">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.CSPGpoArt"));%></th><th><%out.println(po.
                                                    getProperty("etiqueta.CSPUMDenGArticulos")
                                            );%></th><th><%out.println(po.
                                                        getProperty("etiqueta.CSPUMDeSGArticulos"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                    ...
                    <div class="table-scroll" id="table-scrollCMayor">
                        <div class="fixedY" id="fixedYCMayor">
                            <table>
                                <thead>
                                    <tr>
                                            <th><%out.println(po.getProperty("etiqueta.CSPNumCuentaMay"));%></th><th><%out.println(po.
                                                        getProperty("etiqueta.CSPDesCuMaypr"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                    ...
                    <div class="table-scroll" id="table-scrollCCosto">
                        <div class="fixedY" id="fixedYCCosto">
                            <table>
                                <thead>
                                    <tr>
                                            <th><%out.println(po.getProperty("etiqueta.CSPCentroCosto"));%></th><th><%out.println(po.
                                                        getProperty("etiqueta.CSPDenCentroCosto"));%></th><th><%out.println(po.
                                                                getProperty("etiqueta.CSPSocie"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <div id="VentanaModalOrden" class="VentanaModalOR">
            <div id="handle12"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.CSPTituOrdn"));%></label><div class="BotonCerrar_Matc" id="CerrarMCOrden1"><label >X</label></div></div>
                    ...
                    <div class="table-scroll" id="table-scrollOrden">
                        <div class="fixedY" id="fixedYOrden">
                            <table>
                                <thead>
                                    <tr>
                                            <th><%out.println(po.getProperty("etiqueta.CSPOrdn"));%></th><th><%out.println(po.
                                                        getProperty("etiqueta.Reporte_FolioSAM"));%></th><th><%out.println(po.
                                                                getProperty("etiqueta.CSPTXTBRVOrd"));%></th><th><%out.println(po.
                                                                    getProperty("etiqueta.CSPClOrd"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
