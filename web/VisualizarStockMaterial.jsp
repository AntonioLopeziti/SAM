<%-- 
    Document   : VisualizarStockMaterial
    Created on : 22/07/2016, 01:28:30 PM
--%>
...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/StyleVisualizarStockMaterial.css">
    ...
    <body>
        ...
        <div class="contenido">
            <div class="ContentStock">                
                <div class="Datos_info">
                    <div class="BasicoComp11_info">
                        ...
                        <hr>
                        <label><% out.println(po.getProperty("etiqueta.STOCKGeupoArtc"));%> </label><input id="grupoarticulo" style="width: 24%; text-transform: uppercase;" maxlength="9" type="text"><button id="match2" class='BtnMatchIcon2'></button>
                        <hr>
                        ...
                        <hr>
                        <label><% out.println(po.getProperty("etiqueta.STOCKNumLote"));%> </label><input id="lote" style="width: 24%; text-transform: uppercase;" maxlength="10" type="text"><button id="match5" class='BtnMatchIcon2'></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.STOCKSumato"));%></label><input type="checkbox" id="chsum">
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.STOCKStocktras"));%></label><input type="checkbox" id="chtras"><br/>
            ...
            <div id="VentanaModalGrupoArticulo" class="VentanaModal">
                <div id="handle2"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="OCULGArt"><label>X</label></div></div>
                <div class="PanelBntMatch"><button id="retoGArt"><%out.println(po.getProperty("etiqueta.STOCKGeupoArtc"));%></button><hr></div>
                <div id="BuscarParamGrupoArticulo" class="BuscarParam_u">
                    <div class="fondo_Match">
                        <div class="busquedaMatch">
                            <label><%out.println(po.getProperty("etiqueta.CSPGpoArt"));%></label><input type="text" id="BusGArtiulos" name="namegart" style="width:35%; text-transform: uppercase;"/>
                            <hr>
                            <label><%out.println(po.getProperty("etiqueta.CSPUMDenGArticulos"));%></label><input type="text" id="BusDenGArt" name="namegart" style="width:35%;"/>
                            <hr>  
                            <label><%out.println(po.getProperty("etiqueta.CantMaxAcier"));%></label><input type="text"  maxlength="3" name="namegart"  id="numAcMax2"   style="width:10%;"/>
                            <hr>
                        </div>       
                    </div> 
                    <div class="Botones_Match">
                        <img class="BtnMatchIcon" src="images/HR_ok.png" style="margin-right:-4%; cursor:pointer;" id="okgarticulo"/>
                        <img class="BtnMatchIcon" src="images/HR_not.png" style="cursor:pointer;" id="OCULGArt2"/>
                    </div>
                </div>
                <div id="ConsultaTablaGArticulo" style="display: none;">
                    <div class="tablaCab">
                        <div id="table-scrollGArticulo" class="table-scroll">
                            <div id="fixedYGArticulo" class="fixedY">
                                <table>
                                    <thead>
                                        <tr>
                                            <th><%out.println(po.getProperty("etiqueta.CSPGpoArt"));%></th><th><%out.println(po.getProperty("etiqueta.CSPUMDenGArticulos"));%></th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                            <div id="cuerpoDatos">
                                <div class="nofixedX" id="CargarDatosGArticulo">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="VentanaModalLote" class="VentanaModallot">
                <div id="handle5"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="OCULLote"><label>X</label></div></div>
                <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.LoteMa3_Mov"));%></button><hr></div>
                <div id="ConsultaTablalo">
                    <div class="tablaCab">
                        <div id="table-scrolllo" class="table-scroll">
                            <div id="fixedYlo" class="fixedYLO">
                                <table>
                                    <thead>
                                        <tr>
                            ...
                            <div id="cuerpoDatos">
                                <div class="nofixedXLO" id="CargarDatoslote">
                                </div>
                            </div>
                        </div>
                    </div>
