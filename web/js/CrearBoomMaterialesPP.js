...
///// Match Equipos
    ...
    function ConsultaEquipos() {
        ...
        $.ajax({
            async: false,
            type: "GET",
            url: "peticionModuloVisualizarBoom",
...
function loadDesComp() {
    var comp = document.getElementsByName('Tcomp');
...
function GetDesc(num) {
    var acc = "ObtenerDescripcion";
    $.ajax({
        type: 'GET',
        url: 'peticionModuloVisualizarBoom',
        contentType: "application/x-www-form-urlencoded",
        processData: true,
        data: "Action=" + acc + "&Equipo=" + num,
