<%-- 
    ...
    Created on : 27/08/2016, 11:23:17 PM
--%>
...
<html>
    ...
    <%
        ...
        String ReporteMsgNoCentro = po.getProperty("etiqueta.ReporteMsgNoCentro");
        String NoDatos = po.getProperty("etiqueta.ReporteNoExusDatis");
        String NoFolioSAM = po.getProperty("etiqueta.ReporteNoFolioSAM");
        String NoFolioSAP = po.getProperty("etiqueta.ReporteNoFolioSAP");
        String ConsEx = po.getProperty("etiqueta.ReportesConsEx");
    ...
    <body>
            ...
            <div class="ContentReportes">                
                <section class="DivBusqueda">
                    ...
                    <section class='DivIzquierda'>
                        ...
                        <hr>
                        <label id="lblFecha"><%out.println(po.getProperty("etiqueta.Reporte_fechap"));%></label><input id="fechainicio" value="" maxlength="10" onpaste="return false" type="text" value="" style="width:20%;"/><button id="match_F1" class='BtnMatchIcon'></button>
                        <hr>
                    </section>
                    <section class='DivDerecha'>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input id="fechafin" value="" maxlength="10" onpaste="return false" type="text" value="" style="width:20%;"/><button id="match_F2" class='BtnMatchIcon'></button>
                        <hr>
                    </section>
                </section>
        ...
        <div id="VentanaModalCentro" class="VentanaModal">
            ...
            <div id="ConsultaTablaOCompras">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollCentroOrd">
                        <div class="fixedY" id="fixedYCenOrd">
                            <table>
                                <thead>
                                    <tr>
