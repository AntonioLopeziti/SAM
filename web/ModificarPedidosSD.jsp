...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/StylePedidoSDModificar.css"> 
        <link rel="stylesheet" href="css/menu.css" media="screen">
        <script src="js/dom-drag.js"></script>
        <link rel="stylesheet" href="css/jquery-ui.css">
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>     
        <script type="text/javascript" src="js/jquery-iu-1.12.0.js"></script> 
        <script src="js/PedidoSDModificar.js"></script>  
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <title><%out.println(po.getProperty("etiqueta.PedidosSDTituloModif"));%></title>       
    <body>   
        <div id="main-header">    
            <hr>
            <div id="header">
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.PedidosSDTituloModif"));%></h1></div> 
        </div>            
        <div class="contenido">    
        </div>
        <footer>
