<%-- 
    Document   : VisualizarStatusOrdenesPP
    Created on : Apr 26, 2018, 5:49:45 PM
    Author     : Jhonatan
--%>
...
<html>
    ...
    <head>
        ...
        <title>Reporte Status Ordenes PP</title>       
    </head>
    <body> 
        <div id="main-header"> 
            <hr>               
            ...
            <div class="titulo"><h1>Reporte Status Ordenes PP</h1></div>  
        </div>            
        <div class="contenido">
    ...
    <script language="javascript">
        ...
        function retorn() {
            window.location.href = "ReporteStatusOrdenesPP.jsp";
        }
        function fin() {
            window.location.href = "ReporteStatusOrdenesPP.jsp";
        }
        function Correr() {            
            var acc = "ReporteOrdStatPP";
            $.ajax({
                async: false,
                type: 'GET',
                url: 'PeticionVisualizarReportesStatusOrd',
