<%-- 
    Document   : VisualizarNotificacionesPP
...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/NotificacionesPP.css"> 
        <link rel="stylesheet" href="css/menu.css" media="screen">
        <script src="js/dom-drag.js"></script>
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script src="js/VNotificacionesPP.js"></script>  
    ...
    <body>
        ...
        <div class="contenido">
            <div class="ContentNotificaciones">
                ...
                <div class="divOrd">
                    <div class="divOrd1">
                        <label class="tituloequipo"><%out.println(po.getProperty("etiqueta.NPMOrden_PP"));%></label> 
                        <hr class="lineaazul">
                        <div class="ComDiv">
                            <label><%out.println(po.getProperty("etiqueta.NPMOrden_PP"));%></label><input id="ord" type="text"  style=" width:35%; text-transform: uppercase;" maxlength="12" ><button id="match_C1" class='BtnMatchIcon2'></button>
                            <hr>
                            <label><%out.println(po.getProperty("etiqueta.NPMOperacion_PP"));%></label><input id="ope" type="text" style="width: 20%;" maxlength="4"/>
                            <hr>
                            <div hidden>
                                <label>11<%out.println(po.getProperty("etiqueta.NPMSuboperacion"));%></label><input id="subop" type="text" style="width: 20%;" maxlength="4"/>
                                <hr>
                            </div>
                        </div>
                    </div>
...
<!--                <section class="divCap" hidden>
        ...
        <div id="VentanaModalOrden" class="VentanaModal">
            <div id="handle"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US_PP"));%></label><div class="BotonCerrar_Matc"id="btnceor1" ><label >X</label></div></div>
            <div class="PanelBntMatch"><button id="vemoor" ><%out.println(po.getProperty("etiqueta.GralRestriciones_PP"));%></button><hr></div>
            <div id="BuscarParamOrden" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.ReportNumord_PP"));%></label><input type="text" id="NumOrden_Bus" style="width:35%; text-transform: uppercase;"  maxlength="12"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.CSPTxtBrv_PP"));%></label><input type="text" id="TextoOrden_Bus" style="width:35%;" maxlength="40"/>
                        <hr>
                    ...
                    <div class="table-scroll" id="table-scrollOrden">
                        <div class="fixedY" id="fixedYOrden">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.ReportNumord_PP"));%></th><th><%out.println(po.getProperty("etiqueta.CSPTxtBrv_PP"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
