...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/StyleModificaProveedores.css"> 
        <link rel="stylesheet" href="css/menu.css" media="screen">
        <script src="js/dom-drag.js"></script>
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script src="js/ModificaProveedores.js"></script>
        <title><%out.println(po.getProperty("etiqueta.TituloProveedorModif_pro"));%></title>           
    </head>
    <body>  
        <div id="main-header">    
            <hr>
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.TituloProveedorModif_pro"));%></h1></div>                 
        </div>
        <div class="contenido">
            <section class="VisualProveedor_pro">
                <section class="ParametrosBusqueda_pro">
                    ...
                    <section class="SectionComp_pro">
                        <label><%out.println(po.getProperty("etiqueta.Acreedor_pro"));%></label><input maxlength="10" type="text" value="" id="Acreed" maxlength="10" style="width: 15%; background-repeat: no-repeat; background-position-x: -2%;"/><button id="match_C1" class='BtnMatchIcon2'></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Sociedad_pro"));%></label><input maxlength="4" type="text" id="sociedad" maxlength="4" style="width:8%; background-repeat: no-repeat; background-position-x: -2%; text-transform: uppercase;"/><button id="match_C2" class='BtnMatchIcon2'></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.OrgCompras_pro"));%></label><input maxlength="4" type="text" id="org_compras" maxlength="4" style="width:8%; background-repeat: no-repeat; background-position-x: -2%; text-transform: uppercase;"/><button id="match_C3" class='BtnMatchIcon2'></button>
                        <hr>
                    </section>                       
                </section>
                <section class="Direccion_pro">
                    ...
                    <div class="nombresProved">
                        <label><%out.println(po.getProperty("etiqueta.Nombre_pro"));%></label><input style="width:34%;"  value="" type="text" disabled/>
                        <hr>
                    </div>
                    <div class="nombres2Proved">
                        <input type="text" style="width:45%; border:none;" id="nombre1_pro" readonly/> <input type="text" style="width:45%; border:none;" id="nombre2_pro" readonly/>
                        <input type="text" style="width:45%; border:none;" id="nombre3_pro" readonly/> <input type="text" style="width:45%; border:none;" id="nombre4_pro" readonly/>
                    </div>
                    <div class="DirecIzq_pro">    
                        <label><%out.println(po.getProperty("etiqueta.Poblacion_pro"));%></label><input style="width:35%;" id="poblacion_pro" value="" type="text" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.ResidenciaAt_pro"));%></label><input style="width:35%;" id="residencia_pro" value="" type="text" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Calle_pro"));%></label><input style="width:60%;" id="calle_pro" value="" type="text" disabled/>
                        <hr>
                    </div>
                    <div class="DirecDer_pro">
                        <label><%out.println(po.getProperty("etiqueta.Distrito_pro"));%></label><input style="width:60%;" id="distrito_pro" value="" type="text" disabled>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NumEdificio_pro"));%></label><input style="width:20%;" id="edificio_pro" value="" type="text" disabled>
                        <hr>
                    </div>
                </section>
                <section class="DatosSociedad_pro">
                    ...
                    <section class="DatosSoIzq_pro">
                        <label><%out.println(po.getProperty("etiqueta.NumIndFiscal"));%></label><input type="text" id="nif_pro" value="" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.ConPago_pro"));%></label><input type="text" id="pago_pro" value="" style="width:15%;" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.IndABC_pro"));%></label><input type="text" id="ABC_pro" value="" style="width:6%;" disabled/>
                        <hr>
                    </section>
                    <section class="DatosSoDer_pro">
                        <label><%out.println(po.getProperty("etiqueta.GrupoCuenta_pro"));%></label><input type="text" id="grupocuentas_pro" value="" style="width:18%;"disabled>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.CuentaAsoc_pro"));%></label><input type="text" id="cuentaaso_pro" value="" disabled>
                        <hr>
                    </section>
                </section>
                <section class="Compras_pro">
                    ...
                    <hr id="LineatituloPro">
                    <section class="DatosSoIzq_pro">
                        <label><%out.println(po.getProperty("etiqueta.MonedaPedido_pro"));%></label><input type="text" id="moneda_pro" value="" style="width:15%;" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.ValorMinimo_pro"));%></label><input type="text" id="valor_pro" value="" style="width:35%;" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Iconterm_pro"));%></label><input type="text" id="ico1_pro" value="" style="width:10%;" disabled/> <input type="text" id="ico2_pro" value="" style="width:40%;" disabled/>
                        <hr>
                    </section>
                    <section class="DatosSoDer_pro">
                        <label><%out.println(po.getProperty("etiqueta.ControlConfirm_pro"));%></label><input type="text" id="confir_pro" value="" style="width:18%;"disabled>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.GrupoCompras_pro"));%></label><input type="text" id="grupocompras_pro" value="" style="width:20%;" disabled>
                        <hr>
                    </section>
                </section>
                <section class="BloqueoBorrado_pro">
                    ...
                    <section class="SectionComp_pro">
                        <span>
                            <input id="petBor_pro" type="checkbox" disabled><%out.println(po.getProperty("etiqueta.PetiBorSoc_pro"));%>
                            <br>
                            <input id="bloqConta_pro" type="checkbox" disabled><%out.println(po.getProperty("etiqueta.BloqContPSoc_pro"));%>
                            <br>
                            <input id="petBorCe_pro" type="checkbox" disabled><%out.println(po.getProperty("etiqueta.PeBorrado_pro"));%>
                        </span>
                    </section>   
                </section>
            </section>
