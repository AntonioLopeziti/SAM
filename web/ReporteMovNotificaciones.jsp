...
<html>
    ...
    <head>
        ...
        <script src="js/ReporteMovNotificaciones.js" type="text/javascript"></script>
    ...
    <body>
        ...
        <div id="main-header"> 
            ...
            <input style="margin-bottom: 0.266em;" id="ejecutar" type="image" src="images/ejecuta.png" onclick="ValidarMN();"/>
