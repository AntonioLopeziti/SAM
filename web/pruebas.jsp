...
//        
    ...
    <body>
        ...
        <div id="main-header">  
            ...
            <div class="titulo"><h1>SAM CODE TEST</h1></div>
        </div>
        <div class="contenido">
            <div style="width: 50%; background: #FFF; height: 500px; margin-top: 8%;">
                <label style="margin-top: 2%; margin-left: 2%; display: inline-block; width: 10%">Orden: </label><input type="text" id="Orden" value="50" /><br>
                <label style="margin-top: 2%; margin-left: 2%; display: inline-block; width: 10%">Cliente: </label><input type="text" id="Cliente" value="GRUPO RIMAR SA DE CV"/><br>
                <label style="margin-top: 2%; margin-left: 2%; display: inline-block; width: 10%">Descripcion: </label><input type="text" id="Descripcion" value="COFBLKTBCO EV2/32NGO S/F"/><br>
                <label style="margin-top: 2%; margin-left: 2%; display: inline-block; width: 10%">Material: </label><input type="text" id="Material" value="10000004"/><br>
                <label style="margin-top: 2%; margin-left: 2%; display: inline-block; width: 10%">Lote: </label><input type="text" id="Lote" value="LOTESANPER"/><br>
                <label style="margin-top: 2%; margin-left: 2%; display: inline-block; width: 10%">Cantidad: </label><input type="text" id="Cantidad" value="100.000" /><br>
                <label style="margin-top: 2%; margin-left: 2%; display: inline-block; width: 10%">Ancho: </label><input type="text" id="Ancho" value="5.000"/><br>
                <label style="margin-top: 2%; margin-left: 2%; display: inline-block; width: 10%">U.Med. </label><input type="text" id="Unidad"value="KG" /><br>
                <label style="margin-top: 2%; margin-left: 2%; display: inline-block; width: 10%">Pto.Trabajo: </label><input type="text" id="PtoTrabajo" value="BB01" /><br>
                <label style="margin-top: 2%; margin-left: 2%; display: inline-block; width: 10%">Ruta: </label><input type="text" id="Ruta" value="L2"/><br>
                <label style="margin-top: 2%; margin-left: 2%; display: inline-block; width: 10%">Stock: </label><input type="text" id="Stock" value="1" /><br><br><br><br>
                <button id="PrintEtiqueta">Imprimir Etiqueta</button>
            </div>
        </div> 
        <footer>
