            ...
            <div class="ContentReportes">                
                <section class="DivBusqueda">
                    <section class='DivLeft'>
                        ...
                        <hr>
                        <label id="lblFolioSAP">Material</label><input id="material" type="text" style='width: 35%; text-transform: uppercase;' maxlength="12"><button id="match_A3" class='BtnMatchIcon'></button>
                        <hr>
                    ...
                    <section class='DivRight'>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input id="material2" type="text" style='width: 35%; text-transform: uppercase;' maxlength="12"><button id="match_A5" class='BtnMatchIcon'></button>
                        <hr>
