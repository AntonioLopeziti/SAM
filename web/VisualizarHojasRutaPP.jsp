...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/StyleHojaRutaPPVisualizar.css"> 
        <link rel="stylesheet" href="css/menu.css" media="screen">
        <script src="js/dom-drag.js"></script>
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script src="js/HojaRutaPPVisualizar.js"></script>  
        <title><%out.println(po.getProperty("etiqueta.VisualizarHojaRuta_PP"));%></title>       
    <body>
        <div id="main-header">
            <hr>
            <div id="header">
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.VisualizarHojaRuta_PP"));%></h1></div>
        </div>            
        ...
        <div class="contenido">     
            <div class="ContentHojaRuta">
                <div class="BuscarPra">
                    ...
                    <hr id="lineaBomtitu">
                    <div class="div1pa">
                        <label><%out.println(po.getProperty("etiqueta.MateHR_PP"));%></label><input id="EquipoHR" maxlength="18" type="text" style="width:25%; background-repeat: no-repeat; text-transform: uppercase"/><button id="btnmatch"  class="BtnMatchIcon"></button> <input id="DesEquiHR" type="text" readonly="true" style="width: 55%; border: none;  background: none;"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.CentroFabric_PP"));%></label><input id="CentroHR" maxlength="4" type="text" style="width: 15%; text-transform: uppercase; background-repeat: no-repeat;"/><button id="btnmatch2"  class="BtnMatchIcon2"></button> 
                        <hr>
                        ...
                        <section class="TableContainer">
                            <section class="SecHead">
                                <table id="TabHead">
                                    <thead>
                                        <tr>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoCG_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoTxtHRuta_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoOp_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoIDobj_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoCtrl_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoCe_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoAl_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoTxtBreve_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoCantB_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoDurN_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoUnD_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoTrabajo_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoUnT_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoTipoHR_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoGrpHR_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoSec_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoNod_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoLstM_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoSt_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.DescripcionHojaRuta_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoUM_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoOrgC_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoAcredor_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoGrpA_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoRegInf_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoClaCot_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoMoneda_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoGco_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoT_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.TablaCampoI_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.CSPNumSer_PP"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.DescripcionHojaRuta_PP"));%></td>
                                        </tr>
                                    </thead>
                                </table>
                ...
                <div id="BuscarParam" class="BuscarParam_u">
                    <div class="fondo_Match">
                        <div class="busquedaMatch">
                            <label>Material</label><input type="text" id="equiBus" maxlength="18" style="width:35%; text-transform: uppercase;"/>
                            <hr>
                        ...
                        <div class="table-scroll" id="table-scroll">
                            <div class="fixedY" id="fixedY">
                                <table>
                                    <thead>
                                        <tr>
                                            <th>Material</th><th>Denominación Material</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
            ...
            <div id="VentanaModal2" class="VentanaModal">
                ...
                <div id="BuscarParam2" class="BuscarParam_u">
                    <div class="fondo_Match">
                        <div class="busquedaMatch">
                            <label><%out.println(po.getProperty("etiqueta.CentroBOOM_PP"));%></label><input type="text" id="CenBus" maxlength="4" style="width:35%; text-transform: uppercase;"/>
                            <hr>
                            <label><%out.println(po.getProperty("etiqueta.DescripcionBOM_PP"));%></label><input type="text" id="CNombreBus" maxlength="30" style="width:35%; text-transform: uppercase;"/>
                            <hr>
                            <label><%out.println(po.getProperty("etiqueta.CtdMaximaAciertos_PP"));%></label><input maxlength="3" type="text"  id="numAcMax2"  style="width:10%;" />
                            <hr>
                        </div>        
                    </div> 
                    <div class="Botones_Match">
