...
<html>
                                    ...
                                    <table id="TabHead">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><%out.println(po.getProperty("etiqueta.ReportMovIventMovref"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.GralCantidad"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.Reporte_fechap"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReportMovIventAlmacen"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.materialmatch"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.GralDescripcion"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.GralMensaje"));%></td>
                                            </tr>
                                        </thead>
                                    </table>
                                </section>
    ...
    <script language="javascript">
        ...
        function Correr() {
            ...
            var radio = '<%=RADI%>';
            var acc = '<%=ACC%>';
            var param = "Accion=" + acc + "&MATE=" + MATE + "&ALMA=" + ALMA + "&FEC1=" + FEC1 + "&FEC2=" + FEC2 + "&RADI=" + radio;
            $.ajax({
                async: false,
                type: 'GET',
