...
<html>
    ...
    <head>
        ...
        <script src="js/MonitorStatusPP.js"></script> 
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <title><% out.println(po.getProperty("etiqueta.Titulo_MS_PP"));%></title>       
    <body>
        <div id="main-header">   
            <hr>
            <div id="header">
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.TituloModulo_MS_PP"));%></h1></div>      
        </div>            
        <div class="contenido">
            <div class="ContentMonitor">
                <div class="MonitorSect1" hidden>
                    <label><% out.println(po.getProperty("etiqueta.Ejecucion_PP"));%></label>
                    <hr class="LineasMonitor">   
                    <div class="monitrdiv1">
                        <input id="rbt1" type="radio" name="Ejecucion" value="Ubicacion"> <label><% out.println(po.getProperty("etiqueta.Ubicacion_MS_PP")); %></label><br>
                        <input type="radio" name="Ejecucion" value="Material" checked> <label><% out.println(po.getProperty("etiqueta.Equipo_MS"));%></label><br>   
                    </div>
                </div>  
                <div class="parametroBus">
                    <label class="LbMonitor"><% out.println(po.getProperty("etiqueta.Parametro_MS_PP"));%></label>
                    <hr class="LineasMonitor">
                    <div class="subparametoBu">
                        <label><% out.println(po.getProperty("etiqueta.Plani_MS_PP"));%></label><input id="Ctro" maxlength="4" type="text" style="width: 15%; background-repeat: no-repeat; text-transform: uppercase;"/><button id="btnmat1" class='BtnMatchIcon'></button>
                        <hr>
                        <label><% out.println(po.getProperty("etiqueta.PtoTbjoRes_MS_PP"));%></label><input id="PtoTjo" maxlength="10" type="text" style="width: 15%; background-repeat: no-repeat; text-transform: uppercase;"/><button id="btnpto" class='BtnMatchIcon'></button>
                        <hr>
<!--                        <label><% out.println(po.getProperty("etiqueta.Ubi_MS_PP"));%></label><input id="Ubic" maxlength="30" type="text" style="width: 35%; text-transform: uppercase;"/><button id="btnmat2" class='BtnMatchIcon'></button>
                        <hr>-->
                        <label><% out.println(po.getProperty("etiqueta.Material_MS_PP"));%></label><input id="Mte" maxlength="18" type="text" style="width: 20%; background-repeat: no-repeat; text-transform: uppercase;"/><button id="btnmat3" class='BtnMatchIcon'></button> <samp>a</samp> <input id="Mte2" maxlength="18" type="text" style="width: 20%; background-repeat: no-repeat; text-transform: uppercase;"/><button id="btnmat31" class='BtnMatchIcon'></button>
                        <hr>
                        <input hidden id="Idioma" value="<%=Idioma%>"/>
                    </div>
                </div> 
                <div class="divmodovis">
                    <label class="LbMonitor"><% out.println(po.getProperty("etiqueta.Visual_MS_PP")); %></label>
                    <hr class="LineasMonitor">
                    <input type="radio" name="Visualizacion" value="Medidas" checked> <label><% out.println(po.getProperty("etiqueta.Medidas_MS_PP")); %></label><br>
                    <input type="radio" name="Visualizacion" value="Mantenimiento"> <label><% out.println(po.getProperty("etiqueta.Mante_MS_PP"));%></label>    
                </div>
                <div class="divmensajes">
                    <label class="LbMonitor"><% out.println(po.getProperty("etiqueta.Msj_MS_PP")); %></label>
                    <hr class="LineasMonitor">
                    <input type="radio" name="Mensaje" value="Alerta"> <label><% out.println(po.getProperty("etiqueta.Alert_MS_PP")); %></label><br>
                    <input type="radio" name="Mensaje" value="Advertencia"> <label><% out.println(po.getProperty("etiqueta.Adver_MS_PP")); %></label><br>
                    <input type="radio" name="Mensaje" value="NoAdvertencia"> <label><% out.println(po.getProperty("etiqueta.NoAdver_MS_PP")); %></label><br>
                    <input type="radio" name="Mensaje" value="NoContador"> <label><% out.println(po.getProperty("etiqueta.NoCont_MS_PP")); %></label><br>
                    <input type="radio" name="Mensaje" value="Todos" checked> <label><% out.println(po.getProperty("etiqueta.Todo_MS_PP"));%></label>
                </div>
            </div>

        </div>       
        <div id="VentanaModalCentro" class="VentanaModal">
            <div id="handle"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.Centros_MS_PP"));%></label><div class="BotonCerrar_Matc" onclick="ocultarVentana('Centro');"><label >X</label></div></div>
            ...
            <div id="BuscarParamCentro_SP" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.Centros_MS_PP"));%></label><input type="text" id="BusCentro" style="width:35%; text-transform: uppercase;"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Descripcion_MS_PP"));%></label><input type="text" id="BusDesCentro" style="width:35%;"/>
                        <hr>                           
                    ...
                    <div class="table-scroll" id="table-scrollCentro">
                        <div class="fixedY" id="fixedYCentro">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.Centros_MS_PP"));%></th><th><%out.println(po.getProperty("etiqueta.Descripcion_MS_PP"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
...
<!--        <div id="VentanaModalUbiTecn" class="VentanaModal">
            ...
            <div id="BuscarParamUbi" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.UbicacionTecnica_MS_PP"));%></label><input type="text" id="ubictBus" style="width:35%; text-transform: uppercase;"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Descripcion_MS_PP"));%></label><input type="text" id="DesUbiBus" style="width:35%;"/>
                        <hr>
                    ...
                    <div class="table-scroll" id="table-scrollUbitec">
                        <div class="fixedY" id="fixedYUbitec">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.UbicacionTecnica_MS_PP"));%></th><th><%out.println(po.getProperty("etiqueta.Descripcion_MS_PP"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <div id="VentanaModalEquipo" class="VentanaModal">
            ...
            <div id="BuscarParamEquipo" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.GralMaterialAll"));%></label><input type="text" id="equBus" style="width:35%; text-transform: uppercase;"/>
                        <hr>
        ...
        <div id="VentanaModalPuesto" class="VentanaModal">
            <div id="handle6"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.PuestoTrabjotiuma_MS_PP"));%></label><div class="BotonCerrar_Matc" onclick="ocultarVentana('Puesto');"><label >X</label></div></div>
            <div class="PanelBntMatch"><button id="retrpuesto"><%out.println(po.getProperty("etiqueta.puestpTrabj_MS_PP"));%></button><hr></div>
            <div id="BuscarParamPt" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.puestpTrabj_MS_PP"));%></label><input type="text" id="puestp" style="width:35%; text-transform: uppercase;" />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Descripcion_MS_PP"));%></label><input type="text" id="Ptexto_mate" style="width:35%; text-transform: uppercase;"/>
                        <hr>
                    ...
                    <div class="table-scroll" id="table-scrollPuesto">
                        <div class="fixedY" id="fixedYPuesto">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.puestpTrabj_MS_PP"));%></th><th><%out.println(po.getProperty("etiqueta.Descripcion_MS_PP"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
