...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/StyleHojaRutaPPCrear.css"> 
        <link rel="stylesheet" href="css/menu.css" media="screen">
        <script src="js/dom-drag.js"></script>
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script src="js/HojaRutaPPCrear.js"></script>  
        <title><%out.println(po.getProperty("etiqueta.CrearHojaRuta_PP"));%></title>       
    <body>
        <div id="main-header">
            <hr>
            <div id="header">
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.CrearHojaRuta_PP"));%></h1></div>
        </div>            
