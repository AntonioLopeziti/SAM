...
import AccesoDatos.ACC_Pm01_notificaciones;
 ...
 */
@WebServlet(name = "peticionTabPM01", urlPatterns = {"/peticionTabPM01"})
public class peticionTabPM01 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            LinkedList<pm01_notificaciones> tn = ACC_Pm01_notificaciones.ObtenerInstancia().ShowDatPM1(ord, ope);
            if (tn.size() == 0) {
                for (int i = 0; i < 50; i++) {
