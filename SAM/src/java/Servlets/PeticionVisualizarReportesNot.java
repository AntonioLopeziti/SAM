 ...
 *
 */
@WebServlet(name = "PeticionVisualizarReportesNot", urlPatterns = {"/PeticionVisualizarReportesNot"})
public class PeticionVisualizarReportesNot extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            session.setAttribute("SAM1", sam2);
            session.setAttribute("SAP", sap);
            session.setAttribute("ORD", ord);
            session.setAttribute("ORD2", ord2);
