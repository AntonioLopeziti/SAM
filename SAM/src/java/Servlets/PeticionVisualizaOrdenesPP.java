 ...
 * @author Jhonatan
 */
@WebServlet(name = "PeticionVisualizaOrdenesPP", urlPatterns = {"/PeticionVisualizaOrdenesPP"})
public class PeticionVisualizaOrdenesPP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {            
            ...
            switch (Accion) {
                case "ValidarOrden":
                    check = ACC_Orden.ObtenerInstancia().ValidarTipoOrdenPP(orden);
                    out.println(check);
                    break;
            }
