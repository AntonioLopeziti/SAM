 ...
 */
@WebServlet(name = "PeticionModuloCreaMateriales", urlPatterns = {"/PeticionModuloCreaMateriales"})
public class PeticionModuloCreaMateriales extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (accion) {
                ...
                case "GuardarDatos":
                    ...
                    if (ACC_Material.ObtenerInstancia().InsertarMateCrea(mat)) {
