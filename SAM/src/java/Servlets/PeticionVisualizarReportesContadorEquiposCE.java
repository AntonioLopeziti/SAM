 ...
 * @author Jhonatan
 */
@WebServlet(name = "PeticionVisualizarReportesContadorEquiposCE", urlPatterns = {"/PeticionVisualizarReportesContadorEquiposCE"})
public class PeticionVisualizarReportesContadorEquiposCE extends HttpServlet {
