    ...
    public LinkedList<pp_operaciones_noti> TABGRNOTPMNotPP(String ord, String ope) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                pmon.setActividad_ya_notificada01("");
                pmon.setActividad_ya_notificada02("");
                pmon.setActividad_ya_notificada03("");
                pmon.setActividad_ya_notificada04("");
                pmon.setActividad_ya_notificada05("");
                pmon.setActividad_ya_notificada06("");
                pmon.setCantidad_base(rs.getString("cantidad_capacidad_necesaria"));
                pmon.setCantidad_base2("");
                pmon.setCantidad_operacion("");
                pmon.setClase_coste("");
                pmon.setClave_control(rs.getString("clave_control"));
                pmon.setClave_grupo_hoja_ruta("");
                pmon.setClave_moneda("");
                pmon.setContador_general_orden("");
                pmon.setContador_grupo_hojaruta("");
                pmon.setContador_interno("");
                pmon.setCentro(rs.getString("centro"));
                pmon.setIndicador_valor_prede_traba_relevante("");
                pmon.setId_objeto_recurso("");
