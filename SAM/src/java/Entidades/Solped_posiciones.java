 ...
 * @author JaroMX
 */
public class Solped_posiciones {
    int id_solped;
    String folio_sam;
    ...
    public String getClase_doc_solped() {
        return clase_doc_solped;
    }

    public void setClase_doc_solped(String clase_doc_solped) {
        this.clase_doc_solped = clase_doc_solped;
    }
    ...
    public String getOrganización_compras() {
        return organización_compras;
    }

    public void setOrganización_compras(String organización_compras) {
        this.organización_compras = organización_compras;
    }
