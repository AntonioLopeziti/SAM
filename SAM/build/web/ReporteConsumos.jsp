...
<html>
    ...
    <%
        ...
        String NoDatos = po.getProperty("etiqueta.ReporteNoExusDatis");
    ...
    <head>
        ...
        <script src="js/ReporteConsumos.js" type="text/javascript"></script>
        <title><%out.println(po.getProperty("etiqueta.ReporteConsumos_Title"));%></title>      
    </head>
    <body>
        <script>
        $(function () {
        ...
        <div id="main-header">   
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.ReporteConsumos_Title"));%></h1></div>     
        </div>            
        <div class="contenido">
            <div class="ContentReportes">                
                <section class="DivBusqueda">
                    <section class='DivLeft'>
                        <label id="lblFolioSAM"><%out.println(po.getProperty("etiqueta.GralCentroAll"));%></label><input id="centro" type="text" style='width: 10%; text-transform: uppercase;' maxlength="4"><button id="match_A1" class='BtnMatchIcon'></button>
                        <hr>
                        ...
                        <hr>
                        <label id="lblFolioSAP"><%out.println(po.getProperty("etiqueta.Reporte_FolioSAP"));%></label><input id="sap1" type="text" style='width: 35%;text-transform: uppercase;'maxlength="10"><button id="match_A3" class='BtnMatchIcon'></button>
                        <hr>
        ...
        <div id="VentanaModalCentro" class="VentanaModal">
            ...
            <div id="ConsultaTablaOCompras">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollCenCon">
                        <div class="fixedY" id="fixedYCenCon">
                            <table>
                                <thead>
                                    <tr>
                        ...
                        <div id="cuerpoDatos">
                            <div class="nofixedX" id="cargarDatosCen">
                            </div>
                        </div>
                    </div>
                </div>
