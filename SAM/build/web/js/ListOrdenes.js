$(document).ready(function () {
    ...
    $('#ejecutar').click(function () {
        if ($('#clOrdL').val().length > 0) {
            if (validarDato("clOrdL", "ValidarClase", "&ClaseOrden=" + $('#clOrdL').val()) == false) {
        ...
        if ($('#clOrdL2').val().length > 0) {
            if (validarDato("clOrdL2", "ValidarClase", "&ClaseOrden=" + $('#clOrdL2').val()) == false) {
                ShowMsg(3, "images/advertencia.PNG", "audio/saperror.wav");
                $('#clOrdL2').val('');
                $('#clOrdL2').focus();
                return;
        ...
        if ($('#OrdeL').val().length > 0) {
            if (validarDato("OrdeL", "ValidarOrden", "&ord=" + $('#OrdeL').val()) == false) {
        ...
        if ($('#OrdeL2').val().length > 0) {
            if (validarDato("OrdeL2", "ValidarOrden", "&ord=" + $('#OrdeL2').val()) == false) {
                ShowMsg(2, "images/advertencia.PNG", "audio/saperror.wav");
                $('#OrdeL2').val('');
                $('#OrdeL2').focus();
                return;
        ...
        if ($('#SAMOrden').val().length > 0) {
            if (validarDato("SAMOrden", "ValidarSAM", "&sam=" + $('#SAMOrden').val()) == false) {
        ...
        if ($('#SAMOrden2').val().length > 0) {
            if (validarDato("SAMOrden2", "ValidarSAM", "&sam=" + $('#SAMOrden2').val()) == false) {
                ShowMsg(9, "images/advertencia.PNG", "audio/saperror.wav");
                $('#SAMOrden2').val('');
                $('#SAMOrden2').focus();
                return;
        ...
        if ($('#ubitl').val().length > 0) {
            if (validarDato("ubitl", "ValidarUbitec", "&Ubicacion=" + $('#ubitl').val()) == false) {
        ...
        if ($('#ubitl2').val().length > 0) {
            if (validarDato("ubitl2", "ValidarUbitec", "&Ubicacion=" + $('#ubitl2').val()) == false) {
                ShowMsg(4, "images/advertencia.PNG", "audio/saperror.wav");
                $('#ubitl2').val('');
                $('#ubitl2').focus();
                return;
        ...
        if ($('#equiL').val().length > 0) {
            if (validarDato("equiL", "ValidarEquipo", "&Equipo=" + $('#equiL').val()) == false) {
        ...
        if ($('#equiL2').val().length > 0) {
            if (validarDato("equiL2", "ValidarEquipo", "&Equipo=" + $('#equiL2').val()) == false) {
                ShowMsg(5, "images/advertencia.PNG", "audio/saperror.wav");
                $('#equiL2').val('');
                $('#equiL2').focus();
                return;
        ...
        if ($('#ptol').val().length > 0) {
            if (validarDato("ptol", "ValidarPuesto", "&Puesto=" + $('#ptol').val()) == false) {
        ...
        if ($('#ptol2').val().length > 0) {
            if (validarDato("ptol2", "ValidarPuesto", "&Puesto=" + $('#ptol2').val()) == false) {
                ShowMsg(6, "images/advertencia.PNG", "audio/saperror.wav");
                $('#ptol2').val('');
                $('#ptol2').focus();
                return;
    ...
    function ValidarQuery() {
        ...
        if (!(abi.prop('checked') || lib.prop('checked') || ctec.prop('checked'))) {
            ...
            var par = "&cl1=" + clOrdL.val() + "&cl2=" + clOrdL2.val() + "&or1=" + OrdeL.val() + "&or2=" + clOrdL2.val() +
                    ...
                    "&ub1=" + ubitl.val() + "&ub2=" + ubitl2.val() + "&ep1=" + equiL.val() + "&ep2=" + equiL2.val() +
                    "&po1=" + ptol.val() + "&po2=" + ptol2.val() + "&fc1=" + fechaord.val() + "&fc2=" + fechaord2.val() +
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 0) {
                        ...
                        window.location.href = "ListaOrdenes2.jsp?acc=CargarTabla" + par;
                    }
                }
            });
        }
    ...
    $('#retubitec').click(function () {
        $('#BuscarParamUbi').show();
        $('#ConsultaTablaUbicacion').hide();
    });
    $('#UbitteBus').keypress(function (e) {
        var tec = (document).all ? e.keyCode : e.which;
        if (tec == 13) {
            ConsultarUbicacion();
        }
    ...
    $('#DUbitectBus').keypress(function (e) {
        var tec = (document).all ? e.keyCode : e.which;
        if (tec == 13) {
            ConsultarUbicacion();
        }
    ...
    $('#retubitec2').click(function () {
        $('#BuscarParamUbi2').show();
        $('#ConsultaTablaUbicacion2').hide();
    });
    $('#UbitteBus2').keypress(function (e) {
        var tec = (document).all ? e.keyCode : e.which;
        if (tec == 13) {
            ConsultarUbicacion2();
        }
    ...
    $('#DUbitectBus2').keypress(function (e) {
        var tec = (document).all ? e.keyCode : e.which;
        if (tec == 13) {
            ConsultarUbicacion2();
        }
    ...
    $('#retrpuesto2').click(function () {
        $('#BuscarParamPt2').show();
        $('#ConsultaTablaPuesto2').hide();
    });
    $('#puestp2').keypress(function (e) {
        var tec = (document).all ? e.keyCode : e.which;
        if (tec == 13) {
            ConsultarPuesto2();
        }
    ...
    $('#Ptexto_mate2').keypress(function (e) {
        var tec = (document).all ? e.keyCode : e.which;
        if (tec == 13) {
            ConsultarPuesto2();
        }
...
//    $('#CerraOrdmtc21').click(function () {
//        ocultarVentana('VentanaModalOrden2', 'BuscarParam_OR2', 'ConsultaTablaOrden2', 'OrdeL2');
//    });
//    $('#CerraOrdmtc22').click(function () {
//        ocultarVentana('VentanaModalOrden2', 'BuscarParam_OR2', 'ConsultaTablaOrden2', 'OrdeL2');
//    });
//    $('#retord2').click(function () {
//        $('#BuscarParam_OR2').show();
//        $('#ConsultaTablaOrden2').hide();
//    });
//    $('#NumOrden_Bus2').keypress(function (e) {
...
//        return teclalfanu.test(te);
//    });
//    $('#numAcMax23').keypress(function (e) {
//        var tec = (document).all ? e.keyCode : e.which;
//        if (tec == 13) {
//            ConsultaOrden2();
//        }
...
//    });
    ...
    function ConsultarUbicacion() {
        var acc = "ConsultaMatchUbicacion";
        var idioma = $('#Idioma').val();
        var Ubi = $('#UbitteBus').val();
        var DUbi = $('#DUbitectBus').val();
        var cant = $('#numAcMax4').val();
        var datos = "&Ubicacion=" + Ubi + "&DUbicacion=" + DUbi + "&ctd=" + cant + "&Idioma=" + idioma;
        $.ajax({
            async: false,
            type: 'GET',
            url: 'peticionModuloListaOrdenes',
            ...
            success: function (data) {
                if (data == 0) {
                    ...
                    $('#cargarDatosUbicacion').html(data);
    ...
    function ConsultarUbicacion2() {
        var acc = "ConsultaMatchUbicacion2";
        var idioma = $('#Idioma').val();
        var Ubi = $('#UbitteBus2').val();
        var DUbi = $('#DUbitectBus2').val();
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == 0) {
                    ...
                    $('#BuscarParamUbi2').hide();
                    $('#ConsultaTablaUbicacion2').show();
                    $('#cargarDatosUbicacion2').html(data);
                    fnc('table-scrollUbicacion2', 'fixedYUbicacion2');
                    borramsg();
                }
            }
        });
    ...
    function ConsultarPuesto2() {
        var acc = "ConsultaMatchPuesto2";
        var idioma = $('#Idioma').val();
        var pue = $('#puestp2').val();
        var Den = $('#Ptexto_mate2').val();
...
function ValidarUbitec(id) {
    var acc = "ValidarUbitec";
    var ord = $('#' + id).val().toUpperCase();
    var enviar = "&Ubicacion=" + ord;
    if (ord.length > 0) {
        $.ajax({
            async: false,
            type: 'GET',
...
function ValidarPuesto(id) {
    var acc = "ValidarPuesto";
    var pto = $('#' + id).val().toUpperCase();
    var enviar = "&Puesto=" + pto;
    if (pto.length > 0) {
        $.ajax({
            async: false,
            type: 'GET',
