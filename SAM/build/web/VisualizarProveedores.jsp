...
<html>
    ...
    <head>
        ...
        <script src="js/VisualizarProveedor.js"></script>
        <title><%out.println(po.getProperty("etiqueta.TituloProveedor_pro"));%></title>           
    </head>
    <body>  
        <div id="main-header">    
            <hr>
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.TituloProveedor_pro"));%></h1></div>                 
        </div>
        <div class="contenido">
