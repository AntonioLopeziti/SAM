...
<html>
    ...
    <head>
        ...
        <title><%out.println(po.getProperty("etiqueta.ReporteContadorequipos_Title"));%></title>
    </head>
    <body>
        <div id="main-header">      
            <hr>
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.ReporteContadorequipos_Title"));%></h1></div>      
        </div>            
        <div class="contenido">
            <div class="ContentLista">
                <div class="gen">
                    ...
                    <div class="period">
                        <label id="fech" name="fech" class="labelDate"></label> <label class="labelDate"> <%out.println(po.getProperty("etiqueta.ReporteEstatusOrden_Title"));%>: </label> <label class="labelDate"> <% out.println(Nombre);%> </label>
                            ...
                            <section class="TableContainer">
                                <section class="SecHead">
                                    <table id="TabHead">
                                        <thead>
                                            <tr>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequiposOrdnPM"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequiposValorCPM"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequiDocMedi"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.Reporte_fechap"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.Reporte_horadia"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequIndicTablInt"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequElmRefePMPS"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequNumEq"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequNumEqdes"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequpuntomed"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequdocmedi"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequcantid"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequStatus"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteContadorequUnMedDoc"));%></td>
