...
<html>
    ...
    <%
        ...
        po.load(in);
        String notenc = po.getProperty("etiqueta.NPMNotificacionFou");
        String noexiuser = po.getProperty("etiqueta.UsuarioInExist");
    ...
    <head>
        ...
        <script src="js/ReporteActividadesAvisos.js" type="text/javascript"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script  src="js/dom-drag.js"></script>
        <title><%out.println(po.getProperty("etiqueta.ReporteAvisActi_title"));%></title>      
    </head>
    <body>  
        <script>
        $(function () {
        ...
        <div id="main-header"> 
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.ReporteAvisActi_title"));%></h1></div>      
        </div>            
        <div class="contenido">
            <div class="ContentReportes">                
                <section class="DivBusqueda">
                    ...
                    <section class='DivIzquierda'>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.ReporteNumnot"));%></label><input id="noti" type="text" style='width: 35%; text-transform: uppercase;' maxlength="12"><button id="match_A2" class='BtnMatchIcon'></button>
                        <hr>
                    ...
                    <section class='DivDerecha'>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input id="noti2" type="text" style='width: 35%; text-transform: uppercase;' maxlength="12"><button id="match_A5" class='BtnMatchIcon'></button>
                        <hr>
        ...
        <div id="VentanaModalNotificacion" class="VentanaModal">
            <div id="handle3"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="OCULNOT"><label >X</label></div></div>
            <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
            <div id="ConsultaTablaNotificacion">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollNotifi">
                        <div class="fixedY" id="fixedYNotifi">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.ReporteNumnot"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                        <div id="cuerpoDatos">
                            <div class="nofixedX" id="cargarDatosNotifi">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="VentanaModalNotificacion2" class="VentanaModal">
            <div id="handle4"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="OCULNOT2"><label >X</label></div></div>
            <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
            <div id="ConsultaTablaNotificacion2">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollNotifi2">
                        <div class="fixedY" id="fixedYNotifi2">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.ReporteNumnot"));%></th>
                        ...
                        <div id="cuerpoDatos">
                            <div class="nofixedX" id="cargarDatosNotifi2">
                            </div>
                        </div>
                    </div>
                </div>
