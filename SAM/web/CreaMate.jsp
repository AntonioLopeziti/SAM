...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/StyleCreaMat.css">
        <script src="js/dom-drag.js"></script>
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script src="js/CreaMater.js"></script>
    ...
    <div id="main-header">
        ...
        <div class="titulo">
            <h1><%out.println(po.getProperty("etiqueta.titulomaestroCrea_MAT"));%></h1>
        </div>             
    </div>            
    <div class="contenido">
        <div class="ContentMateriales">
            <section class="DatosBasicComp_info">
                ...
                <section class="divdatosEmplazamiento">
                    <label><%=material%></label><input type="text" id="material" maxlength="40" style="width:20%; background-repeat: no-repeat; background-position-x: -1%; text-transform: uppercase;"/>
                    <!--<button id="match_C1" class='BtnMatchIcon2'></button><label id="descripcionj" style="width: 55%;"></label>-->
                    <hr id="lineamaterial">
                    <label><%=centro%></label><input type="text" id="centro" maxlength="4"  style="width: 10%; text-transform: uppercase; background-repeat: no-repeat; background-position-x: -2%;"/>
