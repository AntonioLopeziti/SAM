...
//                $('#msg').html(NPMDurReOb + " " + ord + ": " + r2);
        ...
        <link rel="stylesheet" href="css/StylecrearNotifiPM.css"> 
        <link rel="stylesheet" href="css/menu.css" media="screen">        
        <script src="js/dom-drag.js"></script>
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        <script src="js/NotificacionesPM.js"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <title><%out.println(po.getProperty("etiqueta.NPMNotificacionordenmt"));%></title>  
    ...
    <body>
        ...
        <div id="main-header">    
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.NPMNotificacionespmbuques"));%></h1></div>      
            <!--                mostrarventaavi()-->
        </div>
            ...
            <div class="ContentEquipos">
                <div class="divmatchequipo">
                    ...
                    <section class="subdiv1">
                        <label><%out.println(po.getProperty("etiqueta.NPMOrden"));%></label><input  id="notor" type="text" maxlength="12" onkeypress="mostrar(event, this.value)" style="width:40%;"/><button id="match_N1" class='BtnMatchIcon2'></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NPMOperacion"));%></label><input id="notope" type="text"  maxlength="4" style="width:40%;" />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NPMSuboperacion"));%></label><input id="notsop" type="text" maxlength="4" style="width:40%;" />
                        <hr>
                    </section>
                    <section class="subdiv2">
                        <label><%out.println(po.getProperty("etiqueta.NPMStatus"));%></label><input id="notsta" style="width:80%; background:none; border:none;" type="text" readonly value=""/>
                    </section> 
                    <section class="subdiv3">
                        <button onclick="libbot()" > <img src="images/liberar.png"><span>Liberar</span></button>
                ...
                <section class="divdatosgralEquipos">
                    <label><%out.println(po.getProperty("etiqueta.NPMEquipo"));%></label> 
                    <hr class="lineaazul">
                    <div class="div1gral">
                        <label><%out.println(po.getProperty("etiqueta.NPMEquipo"));%></label><input id="nteq" type="text" style=" width:35%;" disabled/><span style="margin-left: 5%;"><input id="nteqch" Style="vertical-align: middle" type="checkbox"  disabled/><label id="labme" style="color:#ABABA6;"><%out.println(po.getProperty("etiqueta.NPMEquipomontado"));%></label></span>
                        <hr> 
                        <input id="ntdeseq" type="text" style=" width:55%; border:none;"   value="" readonly />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NPEqsuperior"));%></label><input id="notesp"  type="text" disabled><span style="margin-left: 5%;"> <button id="VisDoo" style="width: 35%;" disabled>Visualizar Documentos</button> </span>
                        <hr> 
                        <input id="notdesesp" type="text" style=" width:55%; border:none;" value="" readonly />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NPCentroalma"));%></label><input id="notcent" type="text" disabled style="width: 15%;" /> / <input id="notalm" type="text" disabled style="width: 15%; " />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NPMMaterial"));%></label><input id="notmat" type="text" disabled  style="width: 45%;"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NPMLote"));%></label><input id="notlote" type="text" disabled  style="width: 20%;"/>
                        <hr>
                    </div>
                    <div class="div2gral">
                        <button  onclick="HorasT()" id="desmo" style="padding-right: -5%; width: 48%;"><img style="width:15%; " src="images/desmontar.png" >Desmontar Ensamble</button> 
                        <button  onclick="monta()" id="desmo2" style="width:52%;"><img style="width:13.5%; " src="images/montar.png" >Montar Ensamble</button>
                        ...
                        <section id="SecTab">                                     
                            <table class="TablaCont">
                                <thead>
                                    <tr id="CabeceraTabla">
                                        <td></td>
                                        <td>&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMNF"));%>&nbsp;&nbsp;&nbsp;</td>
                                        <td>&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMOp"));%>&nbsp;&nbsp;&nbsp;</td>
                                        <td>&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMClave"));%>&nbsp;&nbsp;&nbsp;</td>
                                        <td>&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMPtotrb"));%>&nbsp;&nbsp;&nbsp;</td>
                                        <td>&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMCentro"));%>&nbsp;&nbsp;&nbsp;</td>
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMDescripcionoperac"));%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td>&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMCantidad"));%>&nbsp;&nbsp;&nbsp;</td>
<!--                                        <td><%out.println(po.getProperty("etiqueta.NPMCMU"));%></td>-->
                                        <td>&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMDuracion"));%>&nbsp;&nbsp;&nbsp;</td>
                                        <td>&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMNotdur"));%>&nbsp;&nbsp;&nbsp;</td>
                                        <td>&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMUMD"));%>&nbsp;&nbsp;&nbsp;</td>
<!--                                        <td><%out.println(po.getProperty("etiqueta.NPMTrabajo"));%></td>
                                        <td><%out.println(po.getProperty("etiqueta.NPMNottrab"));%></td>-->
<!--                                        <td><%out.println(po.getProperty("etiqueta.NPMUMT"));%></td>
                                        <td><%out.println(po.getProperty("etiqueta.NPMUMD"));%></td>
                                        <td><%out.println(po.getProperty("etiqueta.NPMUMT"));%></td>-->
                    ...
                    <button id="btntab" onclick="selecoftab()"><img src="images/notificaroperacion.png">N.R</button><br><br>                   
        ...
        <div id="VentanaModal" class="VentanaModalCC">
            <div id="handle"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.NPMNumeroorden"));%></label><div class="BotonCerrar_Matc" onclick="ocultarVentana('VentanaModal');"><label >X</label></div></div>
            <div class="PanelBntMatch"><button onclick= "retornaFiltroBus('BuscarParam_u1', 'ConsultaTabla1')"><%out.println(po.getProperty("etiqueta.NPMOrdenespPlanmat"));%></button><hr></div>
            <div id="BuscarParam_u1" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.CecosteMAV"));%></label><input  id="env1vm"   type="text" style="width: 35%;"  onkeypress="enterMat(event)"  />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NPMOrden"));%></label><input id="ordmatvm" aling="center" type="text" style="width: 35%;" onkeypress="enterMat(event)"/>
                        <hr> 
                        <label><%out.println(po.getProperty("etiqueta.NPMTextobreve"));%></label><input type="text" id="txtbrvm" aling="center" style="width: 45%;" onkeypress="enterMat(event)"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NPMCantidadmaxaci"));%></label><input type="text" maxlength="3"  id="env5vm" style="width: 10%;"/>

                    </div>        
                </div> 
                <div class="Botones_Match">
                    <img class="BtnMatchIcon" src="images/HR_ok.png" style="margin-right:-4%;" onclick="cargar('peticionesOrdenesCrearNoti');"/>
                    ...
                    <div class="table-scroll" id="table-scroll">
                        <div class="fixedYM" id="fixedY">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.CecosteMAV"));%></th><th><%out.println(po.getProperty("etiqueta.NPMOrden"));%></th><th><%out.println(po.getProperty("etiqueta.NPMTextobreve"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <div id="ventatabdes" class="Ventabdes">
            <div id="handleDes"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.NPMNotipmbques"));%></label></div>
            <div class="Contentabdes">
                <section class="divtabdes">
                    <label class="tituloequipo"><%out.println(po.getProperty("etiqueta.NPMDatossolidecom"));%></label> 
                    <hr class="lineaazul">
                    <div class="div1vtd">
                        <label><%out.println(po.getProperty("etiqueta.NPMNumerosolccompra"));%></label>
                        ...
                        <label><%out.println(po.getProperty("etiqueta.NPMCtdoperacion"));%></label>
                        <input type="text" style="width: 35%; margin-left: -35%" readonly/>
                        <hr style="margin-top: -1px; width: 25%; margin-left: 10px;">
                        <label><%out.println(po.getProperty("etiqueta.NPMPrecio"));%></label>
                    ...
                    <div class="div2vtd">
                        <label><%out.println(po.getProperty("etiqueta.NPMGrupoarticulo"));%></label>
                        <input type="text" id="grarp31" style="width: 20%; margin-left: -10%;" readonly/>
                        <label style="width:20%; margin-left: 3%;"><%out.println(po.getProperty("etiqueta.NPMClasecoste"));%></label>
                        <input type="text" style="width: 13%; margin-left: -1%;" readonly/>
                        <hr style="margin-top: -1px; width: 25%; margin-left: 10px;">
                        <hr style="margin-top: -10px; width: 20%; margin-left: 51%;">
                        <label ><%out.println(po.getProperty("etiqueta.NPMGrupoCompr"));%></label>
                        ...
                        <label style="width:20%;margin-left: -1%;"><%out.println(po.getProperty("etiqueta.NPMAcreedor"));%></label>
                        <input type="text" id="provp31" style="width: 13%; margin-left: -1%;" readonly/>
                        <hr style="margin-top: -1px; width: 25%; margin-left: 10px;">
                        <hr style="margin-top: -10px; width: 20%; margin-left: 51%;">
                        <label><%out.println(po.getProperty("etiqueta.NPMSolicitante"));%></label>
                        <input type="text" id="solp31" style="width: 20%; margin-left: -10%;" readonly/>
                        <label style="width:20%; margin-left: 3%;"><%out.println(po.getProperty("etiqueta.NPMRegistroinfo"));%></label>
                        <input type="text" style="width: 13%; margin-left: -1%;" readonly/>
                        <hr style="margin-top: -1px; width: 25%; margin-left: 10px;">
                        <hr style="margin-top: -10px; width: 20%; margin-left: 51%;">
                    </div> 
                ...
                <section class="tab1">
                    <table class="TablaCont">
                        <thead>
                            <tr id="CabeceraTabla">
                                <td><%out.println(po.getProperty("etiqueta.NPMNoitem"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMNumserv"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMDescripcion"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMCantidad"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMUMS"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMPrecio"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMPor"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMGrparticulos"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMClasecosto"));%></td>
                ...
                <section class="tab1">
                    <table class="TablaCont">
                        <thead>
                            <tr id="CabeceraTabla">
                                <td><%out.println(po.getProperty("etiqueta.NPMPeriodo"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMITEM"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMBorrado"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMDescripcion"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMCentro"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMAlm"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMNumpro"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMNombreprov"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMCantidad"));%></td>
                ...
                <section class="tab1">
                    <table class="TablaCont">
                        <thead>
                            <tr id="CabeceraTabla">
                                <td><%out.println(po.getProperty("etiqueta.NPMPeriodo"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMPosP"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMEjerc"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMDoc"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMItemdoc"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMTipo"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMMov"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMFechacont"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMCantidad"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMimporte"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMMoneda"));%></td>
            ...
            <div id="BuscarParamTexto" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        ...
                        <label>Texto Libre</label><input type="text" id="bxTextoLNota" style="width:30%;" hidden=""/>
        ...
        <div id="VentanaModalForzar" class="VentanaModalFr">
            <div id="handleAV1"><label id="TituloMatch">Valoración manual</label><div class="BotonCerrar_Matc" onclick="ocultarVentana('VentanaModalForzar', '');"><label >X</label></div></div>
            <div id="BuscarParamAv" class="BuscarParam_u">
                <div class="fondo_MatchAv">
                    <label>Caract.</label>
        ...
        <div id="ventaPM01" class="Ventabdes" style="margin-top: 20px;">
            <div id="handlePM01"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.NPMNotificacionoperor"));%></label><div class="BotonCerrar_Matc" onclick="ocultarVentana('ventaPM01', '');"><label >X</label></div></div>
            <div class="Contentabdes">
                <section class="ve1pm">
                    <label class="tituloequipo"><%out.println(po.getProperty("etiqueta.NPMDatosoper"));%></label> 
                    <hr class="lineaazul">
                    <label style="width:20%; margin-left: 2%;"><%out.println(po.getProperty("etiqueta.NPMOrdenoperacion"));%></label>
                    ...
                    <div class="ve1pm1">
                        ...
                        <label style="width:20%; margin-left: -1%;"><%out.println(po.getProperty("etiqueta.NPMNotificacifinal"));%></label>

                    </div>

                    <div class="ve1pm2">
                        <div class="ve1pm21">
                            <label class="tituloequipo"><%out.println(po.getProperty("etiqueta.NPMTiempoplante"));%></label> 
                            <hr class="lineaazul">
                            <label style="width:20%; margin-left: 3%;"><%out.println(po.getProperty("etiqueta.NPMDuracion"));%></label>
                            ...
                            <label style="width:20%; margin-left: 3%;"><%out.println(po.getProperty("etiqueta.NPMTrabajo"));%></label>
                        ...
                        <div class="ve1pm22">
                            <label class="tituloequipo"><%out.println(po.getProperty("etiqueta.NPMNotificadmomen"));%></label> 
                            <hr class="lineaazul">
                            <label style="width:20%; margin-left: 3%;"><%out.println(po.getProperty("etiqueta.NPMDuracion"));%></label>
                ...
                <section class="ve2pm">
                    <label class="tituloequipo"><%out.println(po.getProperty("etiqueta.NPMNotificacitiem"));%></label> 
                    <hr class="lineaazul">
                    <label style="width:20%; margin-left: 1%;"><%out.println(po.getProperty("etiqueta.NPMDuracionReal"));%></label>
                    <input id="durp1" type="text" style="width: 7%; margin-left: 2%; background: no-repeat" />
                    <select id="durp2" style="margin-left: 2%;">
                        <option value="H">H</option>
                        <option value="MIN">MIN</option>
                    </select>
                    <label style="width:20%; margin-left: 5%;"><%out.println(po.getProperty("etiqueta.NPMNotanotific"));%></label>
                ...
                <section class="tab2">
                    <table class="TablaCont">
                        <thead>
                            <tr id="CabeceraTabla">
                                <td></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMReserva"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMPos"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMMaterial"));%>&nbsp;&nbsp;&nbsp;</td>
                                <td><%out.println(po.getProperty("etiqueta.NPMLotee"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMCantCons"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMCantidaNeces"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMCanttomada"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMCentro"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMUMB"));%></td>
                                <td><%out.println(po.getProperty("etiqueta.NPMAlmacen"));%></td>
                                <!--<td><%out.println(po.getProperty("etiqueta.NPMTextobrvmat"));%></td>-->
                                <td>TextoBreveDelMaterial&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            ...
            <div class="Botpm">
                <button onclick="ListaMateriales()" ><img style="height:15px;" src="images/hoja.PNG" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lista Materiales&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                <button style="" onclick="ConsMat();" > <img style="height:15px;" src="images/cosma2.png" /> <%out.println(po.getProperty("etiqueta.NPMConsumoMate"));%></button>
                <!--Nope<button onclick="LlamarFunc();" style="height:20px;"> <img src="images/palomal.png" style="margin-left: -5%; margin-right:5%;" /><%out.println(po.getProperty("etiqueta.NPMNotificaOper"));%></button>-->
                ...
                <button onclick="cerraventabs('ventaPM01')" ><img  src="images/S_B_CANC.gif" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMFinaliproce"));%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                <!--<button><img  src="images/S_B_CHCK.gif" onclick=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%out.println(po.getProperty("etiqueta.NPMValidar"));%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>-->
            </div> 
        </div>
        <div id="VentanaModalListaMat" class="VentanaModalLM">
            <div id="handle23"><label id="TituloMatch">Lista de Materiales</label><div class="BotonCerrar_Matc" onclick="ocultarVentana('VentanaModalListaMat', '');"><label >X</label></div></div>
        ...
        <div id="VentanaModalHoras" class="VentanaModalH">
            ...
            <br><div id="BuscarParamListH" class="BuscarParam_u">
                <div class="fondo_MatchH">
                    <div class="CldMovH">
                        <label class="cldLeft6">Horas Tabajadas</label>
        ...
        <div id="ventanaavis" class="VenAvisoss">
            <div id="handleAv2"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.NPMInformacion"));%></label><div class="BotonCerrar_Matc" onclick="cerravisos();"><label >X</label></div></div>
            <div class="imgeninfo"><IMG SRC="images/S_B_HINT.gif"  ALT="Info"></div>
            <div class="ContenidoAv">
                <br>
                <label id="etav"><%out.println(po.getProperty("etiqueta.NPMAvisoPant"));%></label>
            </div>
            <div class="BotenAv">
        ...
        <div id="ventanaavis2" class="VenAvisoss">
            <div id="handleAv3"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.NOTSTfincab"));%></label><div class="BotonCerrar_Matc" onclick="cerravisos2();"><label >X</label></div></div>
...
<!--        <div id="ventanaavis2" class="VenAvisoss">
        ...
        <div id="VentModalmat" class="VentanaModalCC">
            ...
            <div id="BuscarParam_u2" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label>Material</label><input id="mmmat"  type="text" style="width: 15%;" maxlength="40" onkeypress="MandarMat(event)" />
                        <input id="mmid" aling="center" type="text" style="width: 15%; margin-left:16px; margin-top:2%;" hidden/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NPMTextobreve"));%></label><input type="text" id="mmtxtbr" maxlength="40" style="width: 45%;" onkeypress="MandarMat(event)"/>
                        <hr>
                        <!--                        Tipo de material-->
                        <label>Tipo de Material</label><input type="text" id="mmtipMatt" maxlength="4" style="width: 45%;" onkeypress="MandarMat(event)"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NPMCantidadmaxaci"));%></label><input type="text"  maxlength="3" id="env5vmat"  style="width: 10%;" value="500"/>
                    </div>       
                </div> 
                <div class="Botones_Match">
                    ...
                    <div class="table-scroll" id="table-scroll">
                        <div class="fixedYM" id="fixedY">
                            <table>
                                <thead>
                                    <tr>
                                        <th>Material</th><th>Almacen</th><th>Texto breve</th><th>Tipo</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
    ...
    <div id="VentanaModalLote" class="VentanaModal">
        <div id="handle6"><label id="TituloMatch">Consultar Lotes</label><div class="BotonCerrar_Matc" onclick="ocultarVentana('VentanaModalLote')"><label >X</label></div></div>
                ...
                <div class="table-scroll" id="table-scroll6">
                    <div class="fixedY" id="fixedY6">
                        <table>
                            <thead>
                                <tr>
                                    <th>Lote</th><th>stocklibre_utilizacion</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <div id="VentanaModalValora" class="VentanaModal">
        <div id="handle9"><label id="TituloMatch">Valoración del Resultado de Inspección</label><div class="BotonCerrar_Matc" onclick="ocultarVentana('VentanaModalValora')"><label >X</label></div></div>
        <div class="PanelBntMatch"><button>Restricciones</button><hr></div>
                ...
                <div class="table-scroll" id="table-scroll21">
                    <div class="fixedY" id="fixedY9">
                        <table>
                            <thead>
                                <tr>
                                    <th>Descrip.breve</th><th>T.Val</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <div id="VentanaModalCodig" class="VentanaModal">
        <div id="handle10"><label id="TituloMatch">Código</label><div class="BotonCerrar_Matc" onclick="ocultarVentana('VentanaModalCodig')"><label >X</label></div></div>
        <div class="PanelBntMatch"><button>Restricciones</button><hr></div>
                ...
                <div class="table-scroll" id="table-scroll21">
                    <div class="fixedY" id="fixedY10">
                        <table>
                            <thead>
                                <tr>
                                    <th>Cód</th><th>Texto breve para el código</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <div id="VentanaModalUSU" class="VentanaModal">
        <div id="handle7"><label id="TituloMatch">No. Personal</label><div class="BotonCerrar_Matc" onclick="ocultarVentana('VentanaModalUSU')"><label >X</label></div></div>
        <div class="PanelBntMatch"><button onclick= "retornaFiltroBus('BuscarParam_GrupoPu', 'ConsultaTabla7')">No.Personal</button><hr></div>
        <div id="BuscarParam_GrupoPu" class="BuscarParam_u" >
            <div class="fondo_Match">
                <div class="busquedaMatch">
                    <label>No. Personal</label><input type="text" id="NOpernot" style="width:20%;"  focus/>
                    <hr>
                    <label>Nombre</label><input type="text" id="Nombrepezzz" style="width:20%;"  />
                    <hr>
                ...
                <div class="table-scroll" id="table-scrollusua">
                    <div class="fixedY" id="fixedYsuarr">
                        <table>
                            <thead>
                                <tr>
                                    <th>No. personal &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>Nombre</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <div id="VenMontEq" class="VenMontEq">
        <div name="handleEQ"  id="handleEQ"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.NOTSTfincab"));%></label><div class="BotonCerrar_Matc" onclick="ocultarVentana('VenMontEq');"><label >X</label></div></div>
        <label><%out.println(po.getProperty("etiqueta.NPMEquipo"));%></label> 
        <hr class="lineaazul2">  
        <div class="div1gralEQ">
            <label><%out.println(po.getProperty("etiqueta.NPMEquipo"));%></label><input id="nteq2" type="text" style=" width:35%;" disabled/><span style="margin-left: 5%;"></span>
            <hr> 
            <input id="ntdeseq2" type="text" style=" width:55%; border:none;"   value="" readonly />
            <hr>
            <label><%out.println(po.getProperty("etiqueta.NPEqsuperior"));%></label><input id="notesp2"  type="text" disabled>
            <hr> 
            <input id="notdesesp2" type="text" style=" width:55%; border:none;" value="" readonly />
            <hr>
            <label><%out.println(po.getProperty("etiqueta.NPCentroalma"));%></label><input id="notcent2" type="text" disabled style="width: 8%;" /> / <input id="notalm2" type="text" disabled style="width: 8%; " />
            <hr>
            <label><%out.println(po.getProperty("etiqueta.NPMMaterial"));%></label><input id="notmat2" type="text" disabled  style="width: 45%;"/>
            <hr>
            <label><%out.println(po.getProperty("etiqueta.NPMLote"));%></label><input id="notlote2" type="text" disabled  style="width: 20%;"/> <input id="notlote22" type="text"  style=" margin-left:5px; width: 20%;"/><button id="match_N22" class='BtnMatchIcon2'></button>
            <hr>
        </div>
        <div class="BotMONTEQ">
    ...
    <div id="VentanaModalLoteEQ" class="VentanaModal">
        <div id="handle8"><label id="TituloMatch">Consultar Lotes</label><div class="BotonCerrar_Matc" onclick="ocultarVentana('VentanaModalLoteEQ')"><label >X</label></div></div>
        <div class="PanelBntMatch"><button>Lotes</button><hr></div>
        <div id="BuscarParam_GrupoP" class="BuscarParam_u" style="display: none">
            <div class="fondo_Match">
                <div class="busquedaMatch">
