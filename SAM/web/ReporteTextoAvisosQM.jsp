...
<html>
    ...
    <head>
        ...
        <script src="js/ReporteTextosAvisosQM.js" type="text/javascript"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script  src="js/dom-drag.js"></script>
        <title><%out.println(po.getProperty("etiqueta.ReporteQMCalidatxtAv_title"));%></title>      
    </head>
    <body>  
        <script>
        $(function () {
        ...
        <div id="main-header"> 
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.ReporteQMCalidatxtAv_title"));%></h1></div>      
        </div>            
        <div class="contenido">
            <div class="ContentReportes">                
                <section class="DivBusquedaNotificaciones">
                    ...
                    <section class='DivIzquierda'>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.notMAA"));%></label><input id="not1" type="text" style='width: 35%; text-transform: uppercase;' maxlength="12"><button id="match_A2" class='BtnMatchIcon'></button>
                        <hr>
                    ...
                    <section class='DivDerecha'>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input id="not2" type="text" style='width: 35%; text-transform: uppercase;' maxlength="12"><button id="match_A5" class='BtnMatchIcon'></button>
                        <hr>
