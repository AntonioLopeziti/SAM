...
<html>
    ...
    <head>
        ...
        <script src="js/ReporteEntradas.js" type="text/javascript"></script>
    ...
    <body>
            ...
            <div class="ContentReportes">                
                <section class="DivBusqueda">
                    ...
                    <section class='DivIzquierda'>
                        ...
                        <hr>
                        <label id="lblFolioSAM"><%out.println(po.getProperty("etiqueta.Reporte_FolioSAM"));%></label><input id="sam1" type="text" style='width: 35%; text-transform: uppercase;' maxlength="10"><button id="match_A1" class='BtnMatchIcon'></button>
                        <hr>
                        <label id="lblFolioSAP"><%out.println(po.getProperty("etiqueta.Reporte_FolioSAP"));%></label><input id="sap1" type="text" style='width: 35%; text-transform: uppercase;' maxlength="10"><button id="match_A2" class='BtnMatchIcon'></button>
                        <hr>
                        <label id="lblFecha"><%out.println(po.getProperty("etiqueta.Reporte_fechap"));%></label><input  maxlength="10" type="text"  id="fecha_inicio" style="width:25%;"/><button id="match_A3" class='BtnMatchIcon'></button>
                        <hr>
                    </section>
                    <section class='DivDerecha'>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input id="sam2" type="text" style='width: 35%;text-transform: uppercase;' maxlength="10"><button id="match_A4" class='BtnMatchIcon'></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input id="sap2" type="text" style='width: 35%; text-transform: uppercase;' maxlength="10"><button id="match_A5" class='BtnMatchIcon'></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input  maxlength="10" type="text"  id="fecha_fin" style="width:25%;"/><button id="match_A6" class='BtnMatchIcon'></button>
                        <hr>
                    </section>
                </section>
        ...
        <div id="VentanaModalSAM1" class="VentanaModal">
            <div id="handle"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="CerrarMCENSAM"><label >X</label></div></div>
            ...
            <div id="ConsultaTablaFolioSAM1">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollSAME1">
                        <div class="fixedY" id="fixedYSAME1">
                            <table>
                                <thead>
                                    <tr>
        ...
        <div id="VentanaModalSAM2" class="VentanaModal">
            <div id="handle2"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="CerrarMCENSAM2"><label >X</label></div></div>
            <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
            <div id="ConsultaTablaFolioSAM2">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollSAME2">
                        <div class="fixedY" id="fixedYSAME2">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.Reporte_FolioSAM"));%></th>
        ...
        <div id="VentanaModalSAP1" class="VentanaModal">
            <div id="handle3"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="CerrarMCSAPE"><label >X</label></div></div>
            <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
            <div id="ConsultaTablaFolioSAP1">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollSAP1">
                        <div class="fixedY" id="fixedYSAP1">
                            <table>
                                <thead>
                                    <tr>
        ...
        <div id="VentanaModalSAP2" class="VentanaModal">
            <div id="handle4"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="CerrarMCSAPE2"><label >X</label></div></div>
            <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
