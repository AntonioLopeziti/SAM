...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/StyleBoomMateriales.css"> 
        <link rel="stylesheet" href="css/menu.css" media="screen">
        <script src="js/dom-drag.js"></script>
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script src="js/VisualizarBoomEquipos.js"></script>  
        <title><%out.println(po.getProperty("etiqueta.VisualizarListMatBOOM"));%></title>       
    <body>
        <div id="main-header">     
            <hr>
            <div id="header">
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.VisualizarListMatBOOM"));%></h1></div>      
        </div>            
            ...
            <div class="ContentBoom">
                <div class="divParamBus">
                    ...
                    <div class="Contenidobus">
                        <label><%out.println(po.getProperty("etiqueta.GralEquipo"));%></label><input type="text" id="EquBoom" maxlength="18" style="width: 22%; background-repeat: no-repeat; text-transform: uppercase;"/><button id="btnmatch"  class="BtnMatchIcon"></button> <input type="text" id="DesEquBM" style="width: 52%; background: none; border: none;" readonly/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.centrotrabajoBOOM"));%></label><input type="text" maxlength="4" id="centrotrab" style="width: 10%; text-transform: uppercase; background-repeat: no-repeat;"><button id="btnmatch2"  class="BtnMatchIcon2"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.AlternativaBOOM"));%></label><input type="text" id="Altern" maxlength="2" style="width: 6%;" />                                
                    </div>
                </div>
                            ...
                            <section class="SecHead">
                                <table id="TabHead">
                                    <thead>
                                        <tr>
                                            <td>&nbsp;&nbsp;&nbsp;</td>
                                            <td><%out.println(po.getProperty("etiqueta.AlternativaBOOM"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.NumeroBom"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.centrotrabajoBOOM"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.ComponenteBOM"));%></td>
                                            <td>Descripcion</td>
                                            <td><%out.println(po.getProperty("etiqueta.CantidadBOM"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.UMBOM"));%></td>
<!--                                            <td><%out.println(po.getProperty("etiqueta.BorradoBOM"));%></td>
                                            <td><%out.println(po.getProperty("etiqueta.PeticiBorraBOM"));%></td>-->
                                        </tr>
                                    </thead>
                                </table>
                            </section>
                ...
                <div id="BuscarParam" class="BuscarParam_u">
                    <div class="fondo_Match">
                        <div class="busquedaMatch">
                            <label><%out.println(po.getProperty("etiqueta.GralEquipo"));%></label><input type="text" id="equiBus" maxlength="18" style="width:35%; text-transform: uppercase;"/>
                            <hr>
                            <label><%out.println(po.getProperty("etiqueta.DenominacionEquBoom"));%></label><input type="text" id="dnEquBus" maxlength="40" style="width:35%;"/>
                            <hr>
                        ...
                        <div class="table-scroll" id="table-scroll">
                            <div class="fixedY" id="fixedY">
                                <table>
                                    <thead>
                                        <tr>
                                            <th><%out.println(po.getProperty("etiqueta.GralEquipo"));%></th><th><%out.println(po.getProperty("etiqueta.DenominacionEquBoom"));%></th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
            ...
            <div id="VentanaModal2" class="VentanaModal">
                ...
                <div id="BuscarParam2" class="BuscarParam_u">
                    <div class="fondo_Match">
                        <div class="busquedaMatch">
                            <label><%out.println(po.getProperty("etiqueta.GralCentroAll"));%></label><input type="text" id="CenBus" maxlength="4" style="width:35%;"/>
                            <hr>
                            <label><%out.println(po.getProperty("etiqueta.GralDescripcion"));%></label><input type="text" id="CNombreBus" maxlength="30" style="width:35%;"/>
                            <hr>
