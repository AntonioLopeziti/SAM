...
<html>
    ...
    <head>
        ...
        <script src="js/ModificarOrden.js"></script>
    ...
    <body>
        <div class="fondo">
            ...
            <div class="contenido">
                <div class="titulo" style="width: 98.7%"><h1>Modificacion de Ordenes PM</h1></div>      
                <div class="ContenidoScrollbar">
                    <div id="cargarMate" hidden></div>
                    <div class="ContentOrden"> 
                        <br>
                        <label style="margin-right: 80px;">Orden</label>
                        ...
                        <div id="VentanaModalOrden" class="VentanaModal">
                            <div id="handle1"><label id="TituloMatch">Número de orden</label><div class="BotonCerrar_Matc" onclick="ocultarVentana('Orden');"><label >X</label></div></div>
                            <div class="PanelBntMatch"><button onclick="changeWindows()">Restricciones</button><hr></div>
                            <div id="BuscarParamOrden" class="BuscarParam_u">
                                <div class="fondo_Match">
                                    <div class="busquedaMatch">
                                        <label>Plan mant.preventivo</label>
