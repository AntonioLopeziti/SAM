...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/ReportePedidosSD.css">
        ...
        <script src="js/ReportePedidosSD.js" type="text/javascript"></script>
    ...
    <body>
        ...
        <div id="main-header"> 
            ...
            <input style="margin-bottom: 0.266em;" id="ejecutar" type="image" src="images/ejecuta.png" onclick="ValidarPed();"/>
            <div class="titulo"><h1>Reporte Pedidos</h1></div>  
        </div>            
        <div class="contenido">
            <div class="ContentReportes">                
                <section class="DivBusqueda">
                    <section class='DivLeft'>
                        <label id="lblFolioSAM">Folio SAM</label><input id="folioSAM" type="text" style='width: 35%; text-transform: uppercase;' maxlength="15"><button id="match_A1" class='BtnMatchIcon'></button>
                        <hr>
                        <label id="lblFolioSAM">Número Documento</label><input id="numDoc" type="text" style='width: 35%; text-transform: uppercase;' maxlength="10"><button id="match_A2" class='BtnMatchIcon'></button>
                        <hr>                        
                    ...
                    <section class='DivRight'>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input id="folioSAM2" type="text" style='width: 35%; text-transform: uppercase;' maxlength="10"><button id="match_A6" class='BtnMatchIcon'></button>
                        <hr>                        
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input id="numDoc2" type="text" style='width: 35%; text-transform: uppercase;' maxlength="10"><button id="match_A4" class='BtnMatchIcon'></button>
                        <hr>                        
