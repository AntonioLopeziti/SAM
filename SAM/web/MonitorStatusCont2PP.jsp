                    ...
                    <section class="MonitorStatusCont">
                        <section id="TablaStatus2">
                            ...
                            <button id="BtnNotPM" type="button" >
                               ...
                               &nbsp;<% out.println(po.getProperty("etiqueta.NotOrden_MSC_PP")); %></button>
                            <p class="last"></p>
                        ...
                        <section id="BusquedaStatus">
                            <section id="BusquedaSec" class="BusqSecc">
                                ...
                                <section class="Radio_Ajuste">                        
                                    <input id="alerta" type="radio" name="Ajuste" value="Alerta"> <label><% out.println(po.getProperty("etiqueta.Alerta_MSC_PP")); %></label><br>
                                    <input id="advert" type="radio" name="Ajuste" value="Advertencia"> <label><% out.println(po.getProperty("etiqueta.Advertencia_MSC_PP")); %></label><br>
                                    <input id="noadvert" type="radio" name="Ajuste" value="NoAdvertencia"> <label><% out.println(po.getProperty("etiqueta.NoAdvertencia_MSC_PP")); %></label><br>
                                    <input id="nocont" type="radio" name="Ajuste" value="NoContador"> <label><% out.println(po.getProperty("etiqueta.NoContador_MSC_PP")); %></label><br>
                                    <input id="todos" type="radio" name="Ajuste" value="Todos"> <label><% out.println(po.getProperty("etiqueta.Todos_MSC_PP")); %></label><br>
                                    <br>
