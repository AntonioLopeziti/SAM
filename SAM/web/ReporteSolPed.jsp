...
<html>
    ...
    <head>
        ...
        <script src="js/ReporteSolped.js" type="text/javascript"></script>
    ...
    <body>  
            ...
            <div class="ContentReportes">                
                <section class="DivBusqueda">
                    ...
                    <section class='DivIzquierda'>
                        <label><%out.println(po.getProperty("etiqueta.GralCentroAll"));%></label><select id="centro" style="width: 32%;"></select>
                        <hr>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Reporte_fechap"));%></label><input value="" maxlength="10" type="text"  id="fechainicio" onpaste="return false" style="width:25%;  background-repeat: no-repeat;"/><button id="match_A5" class='BtnMatchIcon'></button>
                        <hr>
                    </section>
                    <section class='DivDerecha'>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input  maxlength="10" type="text" value="" id="fechafin" onpaste="return false" style="width:25%;  background-repeat: no-repeat;"/><button id="match_A6" class='BtnMatchIcon'></button>
                        <hr>
                    </section>
                </section>
                <section class="DivRadio">
                    <section class='DivLeft'>
                        ...
                        <input type="checkbox" id="ch1" ><label><%out.println(po.getProperty("etiqueta.Reporte_Enviados"));%></label><br/>
                    </section>
                </section>
            </div>
        </div>
        <div id="VentanaModalSAM" class="VentanaModal">
            <div id="handle"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="OCUMatchFSAM"><label >X</label></div></div>
            ...
            <div id="ConsultaTablaFolioSAM">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollS">
                        <div class="fixedY" id="fixedYS">
                            <table>
                                <thead>
                                    <tr>
        ...
        <div id="VentanaModalSAM2" class="VentanaModal">
            <div id="handle2"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="OCUMatchFSAM2"><label >X</label></div></div>
            <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
            <div id="ConsultaTablaFolioSAM2">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollS2">
                        <div class="fixedY" id="fixedYS2">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.Reporte_FolioSAM"));%></th>
        ...
        <div id="VentanaModalSAP" class="VentanaModal">
            <div id="handle3"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="OCUMatchFSAP1"><label >X</label></div></div>
            <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
            <div id="ConsultaTablaFolioSAP">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollSP">
                        <div class="fixedY" id="fixedYSP">
                            <table>
                                <thead>
                                    <tr>
        ...
        <div id="VentanaModalSAP2" class="VentanaModal">
            <div id="handle4"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="OCUMatchFSAP2"><label >X</label></div></div>
            <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
            <div id="ConsultaTablaFolioSAP2">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollSP2">
                        <div class="fixedY" id="fixedYSP2">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.Reporte_FolioSAP"));%></th>
