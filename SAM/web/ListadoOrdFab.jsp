<%-- 
    Document   : ListadoOrdFab
    Created on : Apr 26, 2018, 9:26:42 PM
    Author     : Jhonatan
--%>
...
<html>
    ...
    <head>
            ...
            function ShowMsg(m, im, au, va) {
                ...
                switch (m) {
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        msg = "No existen resultados para dicha busqueda";
                        break;
        ...
        <script src="js/ListOrdFab.js" type="text/javascript"></script>        
        <title>Listado de órdenes de fabricación PP</title>  
    </head>
    <body>
        <script>
            $(function () {
