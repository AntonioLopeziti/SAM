<%-- 
    Document   : ReporteStatusOrdenesPP
    Created on : Apr 26, 2018, 1:55:28 PM
    Author     : Jhonatan
--%>
...
<html>
    ...
    <body>
        ...
        <div id="main-header"> 
            ...
            <input style="margin-bottom: 0.266em;" id="ejecutar" type="image" src="images/ejecuta.png" onclick="ValidarEO();"/>
            <div class="titulo"><h1>Reporte Estatus de Ordenes PP</h1></div>  
        </div>            
        <div class="contenido">
            <div class="ContentReportes">                
                <section class="DivBusqueda">
                    <section class='DivLeft'>
                        ...
                        <hr>
                        <label id="lblFolioSAP">Num Orden</label><input id="sap1" type="text" style='width: 35%; text-transform: uppercase;' maxlength="12"><button id="match_A3" class='BtnMatchIcon'></button>
                        <hr>
                    ...
                    <section class='DivRight'>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input id="sap2" type="text" style='width: 35%; text-transform: uppercase;' maxlength="12"><button id="match_A5" class='BtnMatchIcon'></button>
                        <hr>
