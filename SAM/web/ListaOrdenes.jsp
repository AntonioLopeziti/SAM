...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/StyleListaOrdenes.css"> 
        ...
        <title><%out.println(po.getProperty("etiqueta.TituloListaOrdenes_LO"));%></title>   
    </head>
    <body>
        <script>
            $(function () {
        ...
        <div class="contenido">
            <div class="ContentListMat">
                <div class="divStatuLO">
                    ...
                    <div class="divst1">
                        <input id="abie" value="ABIE" type="checkbox"/><label style="margin-right: 2%;"><%out.println(po.getProperty("etiqueta.Pendiente_LO"));%></label>
                        <input id="lib" value="LIB." type="checkbox"/><label style="margin-right: 2%;"><%out.println(po.getProperty("etiqueta.EnTratamineto_LO"));%></label>
                        <input id="ctec" value="CTEC" type="checkbox"/><label style="margin-right: 2%;"><%out.println(po.getProperty("etiqueta.Concluido_LO"));%></label>
                    </div>
                </div>
                <div class="DivSelecOrdenes_LO">
                    <label><%out.println(po.getProperty("etiqueta.SeleOrde_LO"));%></label>
                    <hr class="titulo_ListO">
                    <section class="SeleOrIzq_LO">
                        <label><%out.println(po.getProperty("etiqueta.ClasOrd_LO"));%></label><input type="text" style="width:12%; text-transform: uppercase;" maxlength="4" id="clOrdL"/><button id="btnmat1" class="BtnMatchIcon"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Ord_LO"));%></label><input type="text" style="width: 30%; text-transform: uppercase;" maxlength="12" id="OrdeL"/><button id="btnmat2" class="BtnMatchIcon"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.GralFolioSAM"));%></label><input type="text" style="width: 30%; text-transform: uppercase;" maxlength="12" id="SAMOrden"/><button id="btnmat3" class="BtnMatchIcon"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.TxtBree_Ordene"));%></label><input type="text" id="txtbrvord" style="width: 45%; text-transform: uppercase;" maxlength="150">
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.UbicTec_LO"));%></label><input type="text" style="width:42%; text-transform: uppercase;" maxlength="30" id="ubitl"/><button id="btnmat4" class="BtnMatchIcon"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Equ_Lo"));%></label><input type="text" style="width:42%; text-transform: uppercase;" maxlength="18" id="equiL"/><button id="btnmat5" class="BtnMatchIcon"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.PtoTbjoRes_LO"));%></label><input type="text" style="width: 25%; text-transform: uppercase;" id="ptol"/><button id="btnmat6" class="BtnMatchIcon2"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.GralFecha"));%></label><input  maxlength="10" type="text" value="" id="fechaord" style="width:25%; background-repeat: no-repeat;" onpaste="return false;"/><button id="btnmat13" class="BtnMatchIcon"></button>
                        <hr>
                    </section>
                    <section class="SelOrDer_LO">
                        <label><%out.println(po.getProperty("etiqueta.A_LO"));%></label><input type="text" style="width: 12%; text-transform: uppercase;" id="clOrdL2"/><button id="btnmat7" class="BtnMatchIcon"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.A_LO"));%></label><input type="text" style="width: 30%; text-transform: uppercase;" id="OrdeL2"/><button id="btnmat8" class="BtnMatchIcon"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.A_LO"));%></label><input type="text" style="width: 30%; text-transform: uppercase;" id="SAMOrden2"/><button id="btnmat9" class="BtnMatchIcon"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.A_LO"));%></label><input type="text" style="width: 45%; text-transform: uppercase;" id="txtbrvord2"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.A_LO"));%></label><input type="text" style="width: 42%; text-transform: uppercase;" id="ubitl2"/><button id="btnmat10" class="BtnMatchIcon"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.A_LO"));%></label><input type="text" style="width: 42%; text-transform: uppercase;" id="equiL2"/><button id="btnmat11" class="BtnMatchIcon"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.A_LO"));%></label><input type="text" style="width: 25%; text-transform: uppercase;" id="ptol2"/><button id="btnmat12" class="BtnMatchIcon"></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.A_LO"));%></label><input  maxlength="10" type="text" value="" id="fechaord2" style="width:25%;  background-repeat: no-repeat;" onpaste="return false;"/><button id="btnmat14" class="BtnMatchIcon"></button>
                        <hr>
                    </section>                      
                </div>
            </div>  
        ...
        <div id="VentanaModalClaseOrden" class="VentanaModal">
            <div id="handle"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.ClaseOrdenManOr"));%></label><div class="BotonCerrar_Matc"id="CerraClaOd"><label >X</label></div></div>
            ...
            <div id="BuscarParamCOr" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.ClaseOrdenMOR"));%></label><input type="text" id="CClaseOrden" maxlength="8" style="width:35%; text-transform: uppercase;" focus/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.textobreveOr"));%></label><input type="text" id="Ctextobreve" maxlength="40" style="width:35%; text-transform: uppercase;"/>
                        <hr>
                    ...
                    <div class="table-scroll" id="table-scrollClaseOrden">
                        <div class="fixedY" id="fixedYClaseOrden">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.ClaseOrdenMOR"));%></th><th><%out.println(po.getProperty("etiqueta.textobreveOr"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <div id="VentanaModalOrden" class="VentanaModal">
            <div id="handle2"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.NumOrdenPM_OR"));%></label><div class="BotonCerrar_Matc"  id="CerraOrdmtc"><label >X</label></div></div>
            <div class="PanelBntMatch"><button id="retord1"><%out.println(po.getProperty("etiqueta.BtnNumOrdenPM_OR"));%></button><hr></div>
            <div id="BuscarParam_OR" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.ordenOr"));%></label><input type="text" id="NumOrden_Bus" maxlength="12" style="width:35%; text-transform: uppercase;"  />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.textobreve_OR"));%></label><input type="text" id="TextoOrden_Bus" maxlength="40" style="width:35%; text-transform: uppercase;"/>
                        <hr>
                    ...
                    <div class="table-scroll" id="table-scrollord">
                        <div class="fixedY" id="fixedYord">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.ordenOr"));%></th><th><%out.println(po.getProperty("etiqueta.textobreve_OR"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <div id="VentanaModalSAM" class="VentanaModal">
            <div id="handle3"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.NumOrdenPM_OR"));%></label><div class="BotonCerrar_Matc"  id="CerraSAMMC"><label >X</label></div></div>
            <div class="PanelBntMatch"><button id="retSAM"><%out.println(po.getProperty("etiqueta.BtnNumOrdenPM_OR"));%></button><hr></div>
            <div id="BuscarParam_SAM" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.textobreve_OR"));%></label><input type="text" id="TextoSAM_ord" maxlength="40" style="width:35%; text-transform: uppercase;"/>
                        <hr>
                    ...
                    <div class="table-scroll" id="table-scrollSAM">
                        <div class="fixedY" id="fixedSAM">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.GralFolioSAM"));%></th><th><%out.println(po.getProperty("etiqueta.textobreve_OR"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <div id="VentanaModalUbiTec" class="VentanaModal">
            <div id="handle4"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.UbicaOR"));%></label><div class="BotonCerrar_Matc" id="Cerrarubute"><label >X</label></div></div>
            ...
            <div id="BuscarParamUbi" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.UbicaOR"));%></label><input type="text" id="UbitteBus" style="width:35%; text-transform: uppercase;" malength="30"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.DenUbiOr"));%></label><input type="text" id="DUbitectBus" style="width:35%; text-transform: uppercase;" maxlength="40"/>
                        <hr>
                    ...
                    <div class="table-scroll" id="table-scrollUbicacion">
                        <div class="fixedY" id="fixedYUbicacion">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.UbicaOR"));%></th><th><%out.println(po.getProperty("etiqueta.DenUbiOr"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <div id="VentanaModalEquipos" class="VentanaModal">
            ...
            <div id="BuscarParamE" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.EquipoOR"));%></label><input type="text" id="equBus" maxlength="30" style="width:35%; text-transform: uppercase"/>
                        <hr>
                    ...
                    <div class="table-scroll" id="table-scrollEquipo">
                        <div class="fixedY" id="fixedYEquipo">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.EquipoOR"));%></th><th><%out.println(po.getProperty("etiqueta.GralDenominacion"));%></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <div id="VentanaModalPuesto" class="VentanaModal">
            <div id="handle6"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.PuestoTrabjotiumaLO"));%></label><div class="BotonCerrar_Matc" id="Cerrapueto"><label >X</label></div></div>
        ...
        <div id="VentanaModalClaseOrden2" class="VentanaModal">
            <div id="handle7"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.ClaseOrdenManOr"));%></label><div class="BotonCerrar_Matc"id="CerraClaOd222"><label >X</label></div></div>
            ...
            <div id="BuscarParamCOr2" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.ClaseOrdenMOR"));%></label><input type="text" id="CClaseOrden2" maxlength="8" style="width:35%; text-transform: uppercase;" focus/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.textobreveOr"));%></label><input type="text" id="Ctextobreve2" maxlength="40" style="width:35%; text-transform: uppercase;"/>
                        <hr>
        ...
        <div id="VentanaModalOrden2" class="VentanaModal">
            <div id="handle8"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.NumOrdenPM_OR"));%></label><div class="BotonCerrar_Matc"  id="CerraOrdmtc22"><label >X</label></div></div>
            <div class="PanelBntMatch"><button id="retord12"><%out.println(po.getProperty("etiqueta.BtnNumOrdenPM_OR"));%></button><hr></div>
            <div id="BuscarParam_OR2" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.ordenOr"));%></label><input type="text" id="NumOrden_Bus2" maxlength="12" style="width:35%; text-transform: uppercase;"  />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.textobreve_OR"));%></label><input type="text" id="TextoOrden_Bus2" maxlength="40" style="width:35%; text-transform: uppercase;"/>
                        <hr>
        ...
        <div id="VentanaModalSAM2" class="VentanaModal">
            <div id="handle9"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.NumOrdenPM_OR"));%></label><div class="BotonCerrar_Matc"  id="CerraSAMMC22"><label >X</label></div></div>
            <div class="PanelBntMatch"><button id="retSAM2"><%out.println(po.getProperty("etiqueta.BtnNumOrdenPM_OR"));%></button><hr></div>
            <div id="BuscarParam_SAM2" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.textobreve_OR"));%></label><input type="text" id="TextoSAM_ord2" maxlength="40" style="width:35%; text-transform: uppercase;"/>
                        <hr>
        ...
        <div id="VentanaModalUbiTec2" class="VentanaModal">
            <div id="handle10"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.UbicaOR"));%></label><div class="BotonCerrar_Matc" id="Cerrarubute22"><label >X</label></div></div>
            ...
            <div id="BuscarParamUbi2" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.UbicaOR"));%></label><input type="text" id="UbitteBus2" style="width:35%; text-transform: uppercase;" malength="30"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.DenUbiOr"));%></label><input type="text" id="DUbitectBus2" style="width:35%; text-transform: uppercase;" maxlength="40"/>
                        <hr>
        ...
        <div id="VentanaModalEquipos2" class="VentanaModal">
            ...
            <div id="BuscarParamE2" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.EquipoOR"));%></label><input type="text" id="equBus2" maxlength="30" style="width:35%; text-transform: uppercase"/>
                        <hr>
        ...
        <div id="VentanaModalPuesto2" class="VentanaModal">
            <div id="handle12"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.PuestoTrabjotiumaLO"));%></label><div class="BotonCerrar_Matc" id="Cerrapueto22"><label >X</label></div></div>
            <div class="PanelBntMatch"><button id="retrpuesto2"><%out.println(po.getProperty("etiqueta.puestpTrabj_LO"));%></button><hr></div>
            <div id="BuscarParamPt2" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        <label><%out.println(po.getProperty("etiqueta.puestpTrabj_LO"));%></label><input type="text" id="puestp2" style="width:35%; text-transform: uppercase;" />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.PTDescripcio"));%></label><input type="text" id="Ptexto_mate2" style="width:35%; text-transform: uppercase;"/>
                        <hr>
