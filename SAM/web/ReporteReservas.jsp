<%-- 
    Document   : ReporteReservas
    Created on : 19/09/2016, 10:38:41 AM
--%>
...
<html>
    ...
    <head>
        ...
        <script src="js/ReporteReservas.js" type="text/javascript"></script>
        <title><%out.println(po.getProperty("etiqueta.ReporteReservas_Title"));%></title>    
    </head>
    <body>
        <script>
            $(function () {
        ...
        <div id="main-header"> 
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.ReporteReservas_Title"));%></h1></div>     
        </div>            
        <div class="contenido">
        ...
        <div id="VentanaModalCentro" class="VentanaModal">
            ...
            <div id="ConsultaTablaOCompras">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollCentroEntr">
                        <div class="fixedY" id="fixedYCenEn">
                            <table>
                                <thead>
                                    <tr>
