...
function ValidarQuery() {
    var centro = $('#folioSAM').val();
    var centro2 = $('#folioSAM2').val();
    var sam1 = $('#numDoc').val();
    var sam2 = $('#numDoc2').val();
    ...
    var enviar = "&centro=" + centro + "&centro2=" + centro2 + "&sam=" + sam1 + "&sam2=" + sam2 + "&fecha1=" + fecha1 + "&fecha2=" + fecha2 + "&radio=" + radio;
    $.ajax({
        async: false,
        type: 'GET',
...
function vali() {
    ...
    if (imagen.is(":visible")) {
        ...
        enviarDatos(centro, centro2, sam1, sam2, fecha1, fecha2, radio);
    }
}
function enviarDatos(centro, centro2, sam1, sam2, fecha1, fecha2, radio) {
    var enviar = "&centro=" + centro + "&centro2=" + centro2 + "&sam1=" + sam1 + "&sam2=" + sam2 + "&Fecha1=" + fecha1 + "&Fecha2=" + fecha2 + "&tipoRad=" + radio;
    $.ajax({
        async: false,
        type: 'GET',
        url: 'ReportePedidosSD',
        ...
        data: enviar,
        success: function (data) {
            location.href = "VisualizaPedidosSD.jsp?" + enviar;
