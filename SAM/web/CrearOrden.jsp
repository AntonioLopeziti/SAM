...
<html>
    ...
    <head>
        ...
        <title><%out.println(po.getProperty("etiqueta.CreaOrdenOR"));%></title>   
        <script>
    ...
    <body>
        ...
        <div class="fondo">
            ...
            <div class="contenido">
                <div class="titulo" style="width: 98.7%"><h1><%out.println(po.getProperty("etiqueta.ModOrdTitulo"));%></h1></div>      
                        ...
                        <section id="cebeceraOrd">
                            ...
                            <div class="DivDatosCrearOrden" id="DatosCabecera">
                                ...
                                <div class="DivDatosBasicos" id="divDatBasicos">
                                    ...
                                    <hr>
                                    <label><%out.println(po.getProperty("etiqueta.CreOrEq"));%></label>
                                    ...
                                    <hr>
                                    <label><%out.println(po.getProperty("etiqueta.CreOrUbTen"));%></label>
