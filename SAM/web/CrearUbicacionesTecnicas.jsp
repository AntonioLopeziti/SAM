<%-- 
    Document   : CrearUbicacionesTecnicas
    Created on : 1/07/2016, 10:55:13 AM
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/styleCUbicTec.css">
        <script src="js/jquery-1.9.1.min.js" type="text/javascript"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
        <title> Crear Ubicación Técnica </title>
        ...
        <script>
            ...
            function Validar() {
                ...
                var ubicactecnica = document.getElementById("UbicacTecnica");
                var indestructura = document.getElementById("IndEstructura");
                if (ubicactecnica.value == "" || ubicactecnica.value == 0 || indestructura.value == "" || indestructura.value == 0)
                {
                    ...
                    men.innerHTML = "Por favor, entre indicador de estructura";
                    setTimeout(function () {
                        men.innerHTML = "";
                        iconm.style.visibility = "hidden";
                    }, 8000);

                    if (indestructura.value != "") {
            ...
            <div id="global">
                ...
                <div style="width:100%;">
                    <div style="width: 100%; margin-top: 5%;">
                        <section class="caja">
                            <div class="user">
                                <label id="ubi1"> <% out.println(ubicactecnica);%> </label><input class="inputubicactecnica" id="UbicacTecnica" type="text" onkeypress="return validar(event)"/>
                            ...
                            <div class="user">
                                <label id="ubi3"><% out.println(nivjerarquicos);%> </label> <label id="NivJerarquicos" class="texBlue2">  </label>
                                <hr class="hrmasccodif">
                            </div>
                        </section>
                    </div>
                ...
                <div style="width:100%;">
                    <div style="width: 100%; margin-top: 5%;">
                        <section class="caja"> 
                            <div class="user">
                                <label id="ubi4"> <% out.println(indestructura);%> </label> <input class="inputindestructura" id="IndEstructura" type="text" onkeypress="return validar(event)"><input type="image" style="vertical-align:middle;cursor:pointer;display: inline-block;" id="btnmat" src="images/match.png" onclick="mostrarVentanaModal('listaEstructuraUbicacionTecnica', document.getElementById('IndEstructura').value)"/> <span style="width: 5px; position: absolute;" id="div_cop"></span> <input name="p1valid" id="p1valid" maxlength="1"  type="hidden"/> <label id="RIndEstructura" class="texBlue">  </label>
                                <hr class="hrindestructura">
                            </div>
                        </section>
                    </div>
                </div>
                ...
                <div style="width:100%;">
                    <div style="width: 100%; margin-top: 5%;">
                        <section class="caja">
                            <div class="user">
                                <label> <% out.println(tpoubictec);%> </label> <input class="inputtpoubictecn" id="TpoUbicTecn" type="text" disabled>
                                <hr class="hrtpoubictecn">
                            </div>
                        </section>
                    </div>
                </div>
                ...
                <div style="width:100%;">
                    <div style="width: 100%; margin-top: 5%;">
                        <section class="cajaColor">
                            <div class="tituloLab"> <label> <% out.println(modelo);%> </label> </div>
                            <hr class="lineaUbic">
                            <div class="user">
                                <label> <% out.println(mubicactecnica);%> </label> <input class="inputmubicactecnica" disabled id="MUbicacTecnica" type="text">
                                <hr class="linealab">
                            </div>
                            <div class="user">
                                <label> <% out.println(ubicref); %> </label> <input class="inputmubicref" id="MUbicRef" type="text" disabled>
                                <hr class="linealab">
                            </div>
                        </section>
                    </div>
                ...
                <div style="width:100%;">
                    <div style="width: 100%; margin-top: 5%;">
                        <section class="cajaColor">
                            <div class="tituloLab"> <label> <% out.println(prefubictecsuperior); %> </label> </div>
                            <hr class="lineaUbic">
                            <div class="user">
                                <label> <% out.println(ubictecnsup); %> </label> <input class="inputubictecsup" id="UbicTecSup" type="text" disabled>
                                <hr class="hrmasccodif">
                            </div>
                            <div class="user">
                                <label> <% out.println(denominacion);%> </label>
                                <hr class="hrmasccodif">
                            </div>
                        </section>
                    </div>
