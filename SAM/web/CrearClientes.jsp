...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/StyleClientesCrear.css"> 
        <link rel="stylesheet" href="css/menu.css" media="screen">
        <script src="js/dom-drag.js"></script>
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script src="js/CrearClientes.js"></script>
        <title><%out.println(po.getProperty("etiqueta.TituloCrearcCliente"));%></title>           
    </head>
    <body>  
        <div id="main-header">   
            <hr>
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.TituloCrearcCliente"));%></h1></div> 
        </div>
        <div class="contenido">
            <section class="VisualProveedor_pro" id='VisualProveedor_pro'>
                <section class="ParametrosBusqueda_pro">
                    ...
                    <section class="SectionComp_pro">
                        <label><%out.println(po.getProperty("etiqueta.Cliente_clie"));%></label><input maxlength="20" type="text"  style="background-repeat: no-repeat; background-position-x: -2%;"  id="Cliente_C"  style="width: 15%;"/>
                        <!--<button id="match_C1" class='BtnMatchIcon2'></button>-->
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Sociedad_pro"));%></label><input maxlength="4" type="text" id="Sociedad_C" style="width:8%; background-repeat: no-repeat; background-position-x: -2%; text-transform: uppercase;"/>
                        <!--<button id="match_C2" class='BtnMatchIcon2'></button>-->
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.OrgVenta_cli"));%></label><input maxlength="4" type="text" id="OrgVentas_C" style="width:8%; background-repeat: no-repeat; background-position-x: -2%; text-transform: uppercase;"/>
                        <!--<button id="match_C3"  class='BtnMatchIcon2'></button>-->
                        <label style="margin-left: 2%;"><%out.println(po.getProperty("etiqueta.CanalDist_cli"));%></label><input maxlength="2" type='text' id="CanalDist_C" style=" width:5%; margin-left: -4%; background-repeat: no-repeat; background-position-x: -2%;" />
                        <!--<button id="match_C4" class='BtnMatchIcon'></button>-->
                        <label style="margin-left: 1%;"><%out.println(po.getProperty("etiqueta.Sector_clie"));%></label><input maxlength="2" type='text' id="Sector_C" style="width:5%; margin-left: -8%; background-repeat: no-repeat; background-position-x: -2%;" />
                        <!--<button id="match_C5" class='BtnMatchIcon'></button>-->
                        <hr>
                    </section>                       
                </section>
                <section class="Direccion_pro">
                    ...
                    <div class="nombresProved">
                        <label><%out.println(po.getProperty("etiqueta.Nombre_pro"));%></label><input id="nombre_CL" value="" style="width:30%; text-transform: uppercase; background-repeat: no-repeat;" type="text" >
                        <hr>
                    </div>
                    <div class="nombres2Proved">
                        <input type="text" style="width:45%; border:none;" id="nombre1_cli" readonly/> <input type="text" style="width:45%; border:none; text-transform: uppercase; background-repeat: no-repeat;" id="nombre2_cli" readonly/>
                        <input type="text" style="width:45%; border:none;" id="nombre3_cli" readonly/> <input type="text" style="width:45%; border:none; text-transform: uppercase; background-repeat: no-repeat;" id="nombre4_cli" readonly/>
                    </div>
                    <div class="DirecIzq_pro">
                        <label><%out.println(po.getProperty("etiqueta.Poblacion_pro"));%></label><input style="width:35%; text-transform: uppercase; background-repeat: no-repeat;" id="poblacion_Cl" value="" type="text" />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.ResidenciaAt_pro"));%></label><input style="width:35%; text-transform: uppercase; background-repeat: no-repeat;" id="residencia_Cl" value="" type="text" />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Calle_pro"));%></label><input style="width:60%; text-transform: uppercase; background-repeat: no-repeat;" id="calle_Cl" value="" type="text" />
                        <hr>
                    </div>
                    <div class="DirecDer_pro">
                        <label><%out.println(po.getProperty("etiqueta.Distrito_pro"));%></label><input style="width:60%; text-transform: uppercase; background-repeat: no-repeat;" id="distrito_Cl" value="" type="text" >
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NumEdificio_pro"));%></label><input style="width:20%; text-transform: uppercase; background-repeat: no-repeat;" id="edificio_Cl" value="" type="text" >
                        <hr>
                    </div>
                </section>
                <section class="DatosSociedad_pro">
                    ...
                    <section class="DatosSoIzq_pro">
                        <label><%out.println(po.getProperty("etiqueta.NumIndFiscal"));%></label><input type="text" id="nif_Cl" value="" style="text-transform: uppercase; background-repeat: no-repeat;"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.ConPago_pro"));%></label><input type="text" id="CondPago_Cl" value="" style="width:15%; text-transform: uppercase; background-repeat: no-repeat;" />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.IndABC_pro"));%></label><input type="text" id="ABC_Cl" value="" style="width:6%; text-transform: uppercase; background-repeat: no-repeat;" />
                        <hr>
                    </section>
                    <section class="DatosSoDer_pro">
                        <label><%out.println(po.getProperty("etiqueta.GrupoCuenta_pro"));%></label><input type="text" id="GpoCuenta_Cl" value="" style="width:18%; text-transform: uppercase; background-repeat: no-repeat;">
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.CuentaAsoc_pro"));%></label><input type="text" id="CtaAsoc_Cl" value="" style="text-transform: uppercase; background-repeat: no-repeat;">
                        <hr>
                    </section>
                </section>
                <section class="Compras_pro">
                    ...
                    <hr id="LineatituloPro">
                    <section class="DatosSoIzq_pro">
                        <label><%out.println(po.getProperty("etiqueta.MonedaPedido_pro"));%></label><input type="text" id="mon_Cl" value="" style="width:15%; text-transform: uppercase; background-repeat: no-repeat;" />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Iconterm_pro"));%></label><input type="text" style="width:8%; text-transform: uppercase; background-repeat: no-repeat;" id="incoP1_Cl" value="" /> <input type="text" id="incoP2_Cl" value="" style="width:40%; text-transform: uppercase; background-repeat: no-repeat;" />
                        <hr>
                    </section>
                    <section class="DatosSoDer_pro">
                        <label><%out.println(po.getProperty("etiqueta.GrupoCompras_pro"));%></label><input type="text" id="GpoComp_Cl" value="" style="width:20%; text-transform: uppercase; background-repeat: no-repeat;" >
                        <hr>
                    </section>
                </section>
                <section class="BloqueoBorrado_pro">
                    ...
                    <section class="SectionComp_pro">
                        <span>
                            <input id="nivelSoc_Cli" type="checkbox" onclick="check();"><%out.println(po.getProperty("etiqueta.PetiBorSoc_pro"));%>
                            <br>
                            <input id="bloConta_Cli" type="checkbox" onclick="check2();"><%out.println(po.getProperty("etiqueta.BloqContPSoc_pro"));%>
                            <br>
                            <input id="petBorCo_Cli" type="checkbox" onclick="check3();"><%out.println(po.getProperty("etiqueta.PeBorrado_pro"));%>
                        </span>
                    </section>   
                </section>
            </section>
        ...
        <footer>
            ...
            <div  class="fecha">
                ...
                <script>
                    function check() {
                        alert("uno");
                        $('#bloqConta_pro').prop("checked", false);
                        $('#petBorCe_pro').prop("checked", false);
                    }                    
                    function check2(){
                        alert("dos");
                        $('#petBor_pro').prop("checked", false);
                        $('#petBorCe_pro').prop("checked", false);
                    }
                    function check3(){
                        alert("tres");
