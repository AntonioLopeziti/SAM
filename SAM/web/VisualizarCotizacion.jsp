...
<html>
    ...
    <%
        ...
        String Ofertanot = po.getProperty("etiqueta.CotizacionOfertaNoEn");
        String campoOb = po.getProperty("etiqueta.CotizacionOfertObli");
    ...
    <head>
        ...
        <script src="js/CotizacionSDVisualizar.js"></script>  
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <title><%out.println(po.getProperty("etiqueta.CotizacionTituliVisua"));%></title>       
    <body>   
        <div id="main-header">    
            <hr>
            <div id="header">
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.CotizacionTituliVisua"));%></h1></div> 
        </div>            
        <div class="contenido">    
            <div class="DivContentVisPedSD">
                <div class="parambus">
                    <div class="DivBusquedaPeSD">
                        ...
                        <hr id="lineaTitulo">
                        <div class="divPed">
                            <label><%out.println(po.getProperty("etiqueta.CotizacionOferta"));%></label><input type="text" style="width: 25%; text-transform: uppercase;" id="txtOferta" maxlength="10" /><button id="MCOferta" class='BtnMatchIcon'></button>
                            <hr>
                        </div>
                    </div>
                </div>
                <div class="contain-cabecera">
                    <div class="divDer">
                        <label><%out.println(po.getProperty("etiqueta.PedidosSDPedido2"));%></label><input tye="text" id="oferta" style="width: 35%;" disabled/>
                        <hr>
                            ...
                            <div class="DivVents" id="DivVentas">
                                ...
                                <div class="contad">
                                    <div class="DetalleCabIzq">
                                        <label><%out.println(po.getProperty("etiqueta.CotizacionClaseOferta"));%></label><input type="text" style="width: 15%;" disabled id="claseOferta"/> <input type="text" style="width: 49%; border: none; background:none;" readonly   />
                                        <hr>
                                        ...
                                        <hr>
                                        <label><%out.println(po.getProperty("etiqueta.PedidosSDMotivoPedido"));%></label><input style="width: 20%" ID="MotivoPed" disabled />
                                        <hr>
                ...
                <div>
                    <div class="DivResPos2">
                        ...
                        <div class="DivResPosiciones" id="ContResPos">
                            <div class="DivRe1">
                                <label><%out.println(po.getProperty("etiqueta.CotizacionOfertaValiD"));%></label><input type="text" style="width: 45%" disabled id="ValidoDe"/>
                                <hr>
                                <label><%out.println(po.getProperty("etiqueta.PedidosSDFechPreEntr"));%></label><input type="text" style="width: 45%;" disabled id="fech_prefEnt"/>
                                <hr>
                            </div>
                            <div class="DivRe2">
                                <label><%out.println(po.getProperty("etiqueta.CotizacionOfertaValiA"));%></label><input type="text" style="width: 30%;" id="ValidoA" disabled/>
                                <hr>
                            </div>
                ...
                <div class="DivPos">
                    ...
                    <div class="Contenidotabs">
                        ...
                        <div class="DivEstatus" id="ContSta">
                            ...
                            <hr>
                            <label><%out.println(po.getProperty("etiqueta.PedidosSDStatMotivo"));%></label><input type="text" id="MotivoRech" style="width: 20%" disabled>
                            <hr>
        ...
        <div id="VentanaModalOfertaSD" class="VentanaModal">
            <div id="handle"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.PedidosSDDocumVe"));%></label><div class="BotonCerrar_Matc" id="CerraMCOferta"><label >X</label></div></div>
            <div class="PanelBntMatch"><button id="retofe"><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
            <div id="BuscarParOfSD" class="BuscarParam_u">
                <div class="fondo_Match">
                    <div class="busquedaMatch">
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.CotizacionClaseOferta"));%></label><input type="text" id="ClaseOf" maxlength="4" style="width:35%; text-transform: uppercase;"/>
                        <hr>  
                ...
                <div class="Botones_Match">
                    <img class="BtnMatchIcon" src="images/HR_ok.png" style="margin-right:-4%; cursor:pointer;" id="okOferta"/>                        
                    <img class="BtnMatchIcon" src="images/HR_not.png" style="cursor:pointer;" id="CerraMCOferta2"/>
                </div>
            </div>            
            <div id="ConsultaTablaOferta" style="display: none;">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollOferta">
                        <div class="fixedY" id="fixedYOferta">
                            <table>
                                <thead>
                                    <tr>
                        ...
                        <div id="cuerpoDatos">
                            <div class="nofixedX" id="cargarDatosOferta">
                            </div>
                        </div>
                    </div>
                </div>
