<%-- 
    Document   : ConsultaAvisos
    Created on : 13/04/2016, 02:15:07 PM
--%>
...
<html>
    ...
    <%
        ...
        String TituloPagina = po.getProperty("etiqueta.TituloPagina");
        String TituloPaginaC = po.getProperty("etiqueta.TituloPaginaC");
        String TituloPantalla = po.getProperty("etiqueta.TituloPantalla");
        String TituloPantallaC = po.getProperty("etiqueta.TituloPantallaC");
    ...
    <head>
        ...
        <script src="js/VisualizarAviso.js"></script>
    ...
    <body>
        ...
        <div class="contenido">
            <div class="ContentAvisos">              
                <section class="divconOrden">
                    <div class="DivBuscarorden">
                        <label><%out.println(po.getProperty(("etiqueta.notificacionMAA")));%></label><input type="text" id="NotifiPM" style="width:20%; background-repeat: no-repeat; background-position-x: -2%; text-transform: uppercase;" maxlength="12"/><button id="btnmatch" class="BtnMatchIcon" ></button>
