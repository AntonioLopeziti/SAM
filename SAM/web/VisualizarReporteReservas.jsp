<%-- 
    Document   : VisualizarReporteReservas
...
<html>
                            ...
                            <section class="TableContainer">
                                <section class="SecHead">
                                    <table id="TabHead">
                                        <thead>
                                            <tr>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteReservaNumreser"));%></td>
    ...
    <script language="javascript">
        function Correr() {
            ...
            var fecha2 = "<%=fecha2%>";
            var error = "<%=error%>";
            if (centro == "" && sam1 == "" && sam2 == "" && sap1 == "" && sap2 == "" && fecha1 == "" && fecha2 == "") {
                Vacio();
            } else if (centro != "") {
                Centro();
            } else if (sam1 != "" && sam2 != "") {//Busqueda rangos SAM
                SAM();
            } else if (sam1 != "" && sam2 == "") {//Busqueda folio SAM1
                SAM1();
            } else if (sam1 == "" && sam2 != "") {//Busqueda folio SAM2
                SAM();
            } else if (sap1 != "" && sap2 != "") {//Busqueda rangos SAP
                SAP();
            } else if (sap1 != "" && sap2 == "") {//Busqueda folio SAP1
                SAP1();
            } else if (sap1 == "" && sap2 != "") {//Busqueda folio SAP2
                SAP();
            } else if (fecha1 != "" && fecha2 != "") {//Busquesa rangos FECHAS
                FECHA();
            } else if (fecha1 != "" && fecha2 == "") { //Busqueda fecha1
                FECHA1();
            } else if (fecha1 == "" && fecha2 != "") {//Busqueda FECHA2
                FECHA();
            } else if (centro != "" && sam1 != "" && sam2 != "" && sap1 != "" && sap2 != "" && fecha1 != "" && fecha2 != "") {//Busqueda TODOS
                TODOS();
            }
        }
