                                    ...
                                    <table id="TabHead">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><%out.println(po.getProperty("etiqueta.ReporteDMFoliDMS"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.ReporteDMSNumDOC"));%></td>
                                                <td><%out.println(po.getProperty("etiqueta.CSPClaseDocumento"));%></td>
