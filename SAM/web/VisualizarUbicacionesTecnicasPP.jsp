...
//            };
        ...
        <script src="js/VisUbicacionesTecnicasPP.js"></script>
        <title><%out.println(po.getProperty("etiqueta.VU_VisVisUbicacionTecnica_PP"));%></title>       
    <body>
        <div id="main-header">     
            <hr>
            <div id="header">
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.VU_VisVisUbicacionTecnica_PP"));%></h1></div>      
        </div>            
        <div class="contenido">
            <div class="ContentUbicaciones">                
                ...
                <div class="DatosGeneUbi">
                    ...
                    <hr id="lineaubititu">
                    <div class="datogen1">
                        <label><%out.println(po.getProperty("etiqueta.VU_Clase_PP"));%></label><input type="text" id="Clase" disabled style="width: 60%;">
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_GrupoAutoriz_PP"));%></label><input type="text" id="GrupoAutoriz" disabled style="width: 35%;">
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_Peso_PP"));%></label><input type="text" id="Peso" disabled style="width: 45%;" value="0,000">
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_NInventario_PP"));%></label><input type="text" id="NInventario" disabled style="width: 45%;">
                        <hr>                                    
                    </div>
                    <div class="datogen2">
                        <label><%out.println(po.getProperty("etiqueta.VU_TamanoDimens_PP"));%></label><input type="text" id="TamanoDimens" disabled style="width: 30%;">
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_PstaEnServDesde_PP"));%></label><input type="text" id="PstaenServ" disabled style="width: 20%;">
                        <hr>                                                                      
                    </div>
                </div>
                <div class="datoEmplaz">
                    ...
                    <div class="subdatoemp">
                        <label><%out.println(po.getProperty("etiqueta.VU_CeEmplazam_PP"));%></label><input type="text" style="width: 10%;" id="CeEmplazam" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_Emplazamiento_PP"));%></label><input type="text" style="width: 18%;" id="Emplazamiento" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_AreaEmpresa_PP"));%></label><input type="text" style="width: 10%;" id="AreaEmpresa" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_PuestoTrabajo_PP"));%></label><input type="text" style="width: 15%;" id="PuestoTrabajo" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_IndicadorABC_PP"));%></label><input type="text" style="width: 8%;" id="IndicadorABC" disabled/>
                        <hr>
                    </div>
                </div>
                <div class="divinputacio">
                    ...
                    <hr id="lineaubititu">
                    <div class="subdatoemp">
                        <label><%out.println(po.getProperty("etiqueta.VU_Sociedad_PP"));%></label><input type="text" style="width: 10%;" id="Sociedad" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_ActivoFijo_PP"));%></label><input type="text" style="width: 20%;" id="ActivoFijo" disabled/> / <input disabled style="width: 10%;" id="ActivoFijoDos"  type="text"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_CentroCoste_PP"));%></label><input type="text" style="width: 18%;" id="Centro" disabled/> / <input disabled style="width: 10%;" id="SociedadCC" type="text">
                        <hr>                                
                    </div>
                </div>
                <div class="divResponsa">
                    ...
                    <hr id="lineaubititu">
                    <div class="subdatoemp">
                        <label><%out.println(po.getProperty("etiqueta.VU_CentroPlanif_PP"));%></label><input type="text" style="width: 10%;" id="CentroPlanif" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_GrupoPlanif_PP"));%></label><input type="text" style="width: 10%;" id="GrupoPlanif" disabled/> 
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_PtoTbjoResp_PP"));%></label><input type="text" style="width: 15%;" id="PtoTbjoResp" disabled/> <input disabled style="width: 10%;" id="PtoTbjoRespDos" type="text">
                        <hr>                                
                    </div>
                </div>
                <div class="divEstuc">
                    ...
                    <hr id="lineaubititu">
                    <div class="subdatoemp">
                        <label><%out.println(po.getProperty("etiqueta.VU_UbicTecn_PP"));%></label><input type="text" style="width: 35%;" id="UbicTecn" disabled/>
                        <hr>
                    </div>
                </div>
            </div>
