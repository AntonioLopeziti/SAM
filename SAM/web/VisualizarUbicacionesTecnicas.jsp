...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/StyleUbicacionesTecnicas.css"> 
        <link rel="stylesheet" href="css/menu.css" media="screen">
        <script src="js/dom-drag.js"></script>
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script src="js/VisualizarUbicacionesTec.js"></script>
        <title><%out.println(po.getProperty("etiqueta.VU_VisualizarUbicacionTecnica"));%></title>       
    <body>
        <div id="main-header">     
            <hr>
            <div id="header">
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.VU_VisualizarUbicacionTecnica"));%></h1></div>      
        </div>            
        <div class="contenido">
            <div class="ContentUbicaciones">                
                <div class="divubic">
                    <label><%out.println(po.getProperty("etiqueta.VU_UbicacionTecnica"));%></label>
                    <hr id="lineaubititu">
                    <div class="divubic1">
                ...
                <div class="DatosGeneUbi">
                    <label><%out.println(po.getProperty("etiqueta.VU_DatosGenerales"));%></label>
                    <hr id="lineaubititu">
                    <div class="datogen1">
                        <label><%out.println(po.getProperty("etiqueta.VU_Clase"));%></label><input type="text" id="Clase" disabled style="width: 60%;">
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_GrupoAutoriz"));%></label><input type="text" id="GrupoAutoriz" disabled style="width: 35%;">
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_Peso"));%></label><input type="text" id="Peso" disabled style="width: 45%;" value="0,000">
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_NInventario"));%></label><input type="text" id="NInventario" disabled style="width: 45%;">
                        <hr>                                    
                    </div>
                    <div class="datogen2">
                        <label><%out.println(po.getProperty("etiqueta.VU_TamanoDimens"));%></label><input type="text" id="TamanoDimens" disabled style="width: 30%;">
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_PstaEnServDesde"));%></label><input type="text" id="PstaenServ" disabled style="width: 20%;">
                        <hr>                                                                      
                    </div>
                </div>
                <div class="datoEmplaz">
                    <label><%out.println(po.getProperty("etiqueta.VU_DatosEmplazamiento"));%></label>
                    <hr id="lineaubititu">
                    <div class="subdatoemp">
                        <label><%out.println(po.getProperty("etiqueta.VU_CeEmplazam"));%></label><input type="text" style="width: 10%;" id="CeEmplazam" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_Emplazamiento"));%></label><input type="text" style="width: 18%;" id="Emplazamiento" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_AreaEmpresa"));%></label><input type="text" style="width: 10%;" id="AreaEmpresa" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_PuestoTrabajo"));%></label><input type="text" style="width: 15%;" id="PuestoTrabajo" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_IndicadorABC"));%></label><input type="text" style="width: 8%;" id="IndicadorABC" disabled/>
                        <hr>
                    </div>
                </div>
                <div class="divinputacio">
                    <label><%out.println(po.getProperty("etiqueta.VU_Imputacion"));%></label>
                    <hr id="lineaubititu">
                    <div class="subdatoemp">
                        <label><%out.println(po.getProperty("etiqueta.VU_Sociedad"));%></label><input type="text" style="width: 10%;" id="Sociedad" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_ActivoFijo"));%></label><input type="text" style="width: 20%;" id="ActivoFijo" disabled/> / <input disabled style="width: 10%;" id="ActivoFijoDos"  type="text"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_CentroCoste"));%></label><input type="text" style="width: 18%;" id="Centro" disabled/> / <input disabled style="width: 10%;" id="SociedadCC" type="text">
                        <hr>                                
                    </div>
                </div>
                <div class="divResponsa">
                    <label><%out.println(po.getProperty("etiqueta.VU_Responsabilidades"));%></label>
                    <hr id="lineaubititu">
                    <div class="subdatoemp">
                        <label><%out.println(po.getProperty("etiqueta.VU_CentroPlanif"));%></label><input type="text" style="width: 10%;" id="CentroPlanif" disabled/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_GrupoPlanif"));%></label><input type="text" style="width: 10%;" id="GrupoPlanif" disabled/> 
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.VU_PtoTbjoResp"));%></label><input type="text" style="width: 15%;" id="PtoTbjoResp" disabled/> <input disabled style="width: 10%;" id="PtoTbjoRespDos" type="text">
                        <hr>                                
                    </div>
                </div>
                <div class="divEstuc">
                    <label><%out.println(po.getProperty("etiqueta.VU_Estructura"));%></label>
                    <hr id="lineaubititu">
                    <div class="subdatoemp">
                        <label><%out.println(po.getProperty("etiqueta.VU_UbicTecn"));%></label><input type="text" style="width: 35%;" id="UbicTecn" disabled/>
                        <hr>
                    </div>
                </div>
            </div>
