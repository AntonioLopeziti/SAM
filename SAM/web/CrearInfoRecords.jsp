...
<html>
    ...
    <%
        ...
        String InfRecEx = po.getProperty("etiqueta.InfoRecExCrea_MAT");
        String InfRecGuardEx = po.getProperty("etiqueta.InfoRecCreadExitCrea_MAT");
        String InfRecNoGuard = po.getProperty("etiqueta.InfoRecNoCreadCrea_MAT");
    %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/StyleInfoRecordsCrea.css"> 
        <link rel="stylesheet" href="css/menu.css" media="screen">
        <script src="js/dom-drag.js"></script>
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script src="js/CrearInfoRecords.js"></script>
        <title><%out.println(po.getProperty("etiqueta.TituloCrearInfoRecord_info"));%></title>           
    </head>
    <body>  
        <div id="main-header">    
            <hr>
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.TituloCrearInfoRecord_info"));%></h1></div> 
        </div>
        <div class="contenido">
            <section class="VisualInfoRecord_info">
                <section class="ParametrosBusqueda_info">
                    ...
                    <section class="ParamIzq_info">
                        ...
                        <hr id="LineaTituloInfo">
                        <span><label style="margin-top: 15%;"><%out.println(po.getProperty("etiqueta.RegistroInfo_info"));%></label><input type="text" id="info_IR" maxlength="10" style="width:45%; background-repeat: no-repeat; "/>
                            <!--<button id="Match_I1" class='BtnMatchIcon'></button>-->
                    ...
                    <section class="ParamDer_info">
                        ...
                        <hr id="LineaTituloInfo">
                        <label><%out.println(po.getProperty("etiqueta.Material_info"));%></label><input type="text" id="material_IR" value="" maxlength="40" style="width:50%; background-repeat:no-repeat;"/>
                        <!--<button id="Match_I2" class='BtnMatchIcon'></button>-->
                        <hr id="lineaParamDer_info">
                        <label><%out.println(po.getProperty("etiqueta.Provedor_info"));%></label><input type="text" id="proveedor_IR" value="" maxlength="10" style="  width: 15%; background-repeat: no-repeat; "/>
                        <!--<button id="Match_I3" class='BtnMatchIcon'></button> <input type="text" style="width:45%; border: none;" id="nombrePro_IR" readonly/>-->
                        <hr id="lineaParamDer_info">
                        <label><%out.println(po.getProperty("etiqueta.OrgaComp_info"));%></label><input type="text" id="orgCompras_IR" value=""  maxlength="4" style="width:10%; text-transform: uppercase; background-repeat: no-repeat;"/>
                        <!--<button id="Match_I4" class='BtnMatchIcon'></button>-->
                        <hr id="lineaParamDer_info">
                        <label><%out.println(po.getProperty("etiqueta.Tipoinfo_info"));%></label><input type="text" id="Infotipo_IR" value=""  maxlength="1" style="width:5%; background-repeat: no-repeat;"/>
                        <!--<button id="Match_I5" class="BtnMatchIcon"></button>-->
                        <hr id="lineaParamDer_info">
                        <label><%out.println(po.getProperty("etiqueta.Centro_info"));%></label><input type="text" id="centro_IR" value=""  maxlength="4" style="width:10%; text-transform: uppercase; background-repeat: no-repeat"/>
                        <!--<button id="Match_I6" class='BtnMatchIcon'></button>-->
                        <hr id="lineaParamDer_info">
                    </section>
                </section>
                <section class="DatosBasicComp_info">
                    ...
                    <section class="BasicoComp1_info">
                        <label><%out.println(po.getProperty("etiqueta.GrupoArtculos_info"));%></label><input id="GrupoArticulos_IR" type="text" style="width: 25%; text-transform: uppercase; background-repeat: no-repeat"  />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.GrupoCompras_info"));%></label><input id="GrupoCompras_IR" type="text" style="width: 10%; text-transform: uppercase; background-repeat: no-repeat"  />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.PlazEntrPrev_info"));%></label><input id="PlazaEntr_IR" type="text" style="width: 10%; text-transform: uppercase; background-repeat: no-repeat"/>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.NumMatPro_info"));%></label><input id="NumMatPro_IR" type="text" style="width: 40%; text-transform: uppercase; background-repeat: no-repeat"/>
                        <hr>
                    </section>
                    <section class="BasicoComp2_info">
                        <label><%out.println(po.getProperty("etiqueta.CantStandar_info"));%></label><input id="CantidadStandar_IR" type="text" style="width:30%; text-transform: uppercase; background-repeat: no-repeat" />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.CantMaxima_info"));%></label><input id="CantidadMaxima_IR" type="text" style="width:30%; text-transform: uppercase; background-repeat: no-repeat"  />
                        <hr>
                    </section>
                    <section class="BasicoComp3_info">
                        <label><%out.println(po.getProperty("etiqueta.SinTextoMat_info"));%></label><input id="SinText_IR" type="text" style="width:10%; text-transform: uppercase; background-repeat: no-repeat" />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.IndObligConFped_info"));%></label><input id="IndObl_IR" type="text" style="width:10%; text-transform: uppercase; background-repeat: no-repeat" />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.TolSumIncom_info"));%></label><input id="TolSumImc_IR" type="text" style="width: 18%; text-transform: uppercase; background-repeat: no-repeat" />
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Tolecsum_info"));%></label><input id="TolecSum_IR" type="text" style="width:18%; text-transform: uppercase; background-repeat: no-repeat" />
                        <hr>
                    </section>
                </section>
                <section class="Convers_info">
                    ...
                    <section class="ConverCompl_info">
                        <label><%out.println(po.getProperty("etiqueta.CntUniMedPed_info"));%></label><input id="CantUniMedPed_IR" type="text" style="width:15%; text-transform: uppercase; background-repeat: no-repeat" /><input id="CantUniMedPed2_IR" value="" type="text" style="width:10%; margin-left: 1px; text-transform: uppercase; background-repeat: no-repeat" />
                        <hr>                                    
                    </section>
                    <section class="ConverCompl2_info">
                        <label><%out.println(po.getProperty("etiqueta.CntUniMeBase_info"));%></label><input id="CantUniMedBase_IR" value="" type="text" style="width:15%; text-transform: uppercase; background-repeat: no-repeat" /><input id="CantUniMedBase2_IR" value="" type="text" style="width:10%; margin-left: 1px; text-transform: uppercase; background-repeat: no-repeat" />
                    </section>
                </section>
                <section class="SecPrecio_info">
                    ...
                    <section class="PreciDer_info">
                        <label style="width:25%; display: inline-block;"><%out.println(po.getProperty("etiqueta.PrecioNeto_info"));%></label><input id="PrecioNeto_IR"type="text" style="width:15%; text-transform: uppercase; background-repeat: no-repeat" /><input id="ClaveMoneda_IR" value="" type="text" style="width:10%; margin-left: 1px; text-transform: uppercase; background-repeat: no-repeat" /><label style="margin-left:6%;"><%out.println(po.getProperty("etiqueta.Por_info"));%></label><input id="CntBase_IR" type="text" style="width:15%; margin-left: 3%; text-transform: uppercase; background-repeat: no-repeat"/><input id="CntBase2_IR" value type="text" style="width:10%; margin-left:1px; text-transform: uppercase; background-repeat: no-repeat" />
                        <hr style="width:25%; margin-top: -1px; margin-left: 0;">
                    </section>
                    <section class="PreciDer1_info">
                        <label><%out.println(po.getProperty("etiqueta.IndImpuest_info"));%></label><input id="IVA_IR" value="" type="text" style="width:8%; margin-left: 5%; text-transform: uppercase; background-repeat: no-repeat"/>
                        <hr>
                    </section>
                </section>
            </section>
    ...
    <script>
        ...
        function EnviarDatosInfo(info) {
            //alert(info);
            var url = "peticionCrearEnfoRecords";
