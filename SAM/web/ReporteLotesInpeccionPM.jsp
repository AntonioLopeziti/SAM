...
<html>
    ...
    <%
        ...
        po.load(in);
         String usenot = po.getProperty("etiqueta.UsuarioInExist");
         String loteinno = po.getProperty("etiqueta.LotesInpNot");
    ...
    <head>
        ...
        <script src="js/ReporteLoteInpeccionPM.js" type="text/javascript"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script  src="js/dom-drag.js"></script>
        <title><%out.println(po.getProperty("etiqueta.ReportesLotInps_Ttle"));%></title>      
    </head>
    <body>  
        <script>
        $(function () {
        ...
        <div id="main-header"> 
            ...
            <div class="titulo"><h1><%out.println(po.getProperty("etiqueta.ReportesLotInps_Ttle"));%></h1></div>      
        </div>            
        <div class="contenido">
            <div class="ContentReportes">                
                <section class="DivBusquedaNotificaciones">
                    ...
                    <section class='DivIzquierda'>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Reporte_FolioSAM"));%></label><input id="sam1" type="text" style='width: 35%; text-transform: uppercase;' maxlength="10"><button id="match_A1" class='BtnMatchIcon'></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.ReportesLoteInp"));%></label><input id="lote1" type="text" style='width: 35%; text-transform: uppercase;' maxlength="12"><button id="match_A2" class='BtnMatchIcon'></button>
                        <hr>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Usuario_USCR"));%></label><input type="text" id="usuario" maxlength="12" style="width:30%;  background-repeat: no-repeat; text-transform: uppercase;"/><button id="match_A4" class='BtnMatchIcon'></button>
                        <hr>
                    </section>
                    <section class='DivDerecha'>
                        ...
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input id="lote2" type="text" style='width: 35%; text-transform: uppercase;' maxlength="12"><button id="match_A6" class='BtnMatchIcon'></button>
                        <hr>
                        <label><%out.println(po.getProperty("etiqueta.Rango_a"));%></label><input id="fechafin"  maxlength="10" type="text"  onpaste="return false" style="width:25%;  background-repeat: no-repeat;"/><button id="match_A7" class='BtnMatchIcon'></button>
                        <hr>
                    </section>
                </section>
        ...
        <div id="VentanaModalLotePM" class="VentanaModal">
            <div id="handle3"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="OCULLOTEPM"><label >X</label></div></div>
            <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
            <div id="ConsultaTablaLotePM">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollLotePM">
                        <div class="fixedY" id="fixedYLotePM">
                            <table>
                                <thead>
                                    <tr>
                        ...
                        <div id="cuerpoDatos">
                            <div class="nofixedX" id="cargarDatosLotePM">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="VentanaModalLotePM2" class="VentanaModal">
            <div id="handle4"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="OCULLOTEPM2"><label >X</label></div></div>
            <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
            <div id="ConsultaTablaLotePM2">
                <div class="tablaCab">
                    <div class="table-scroll" id="table-scrollLotePM2">
                        <div class="fixedY" id="fixedYLotePM2">
                            <table>
                                <thead>
                                    <tr>
                                        <th><%out.println(po.getProperty("etiqueta.ReportesLoteInp"));%></th>
                        ...
                        <div id="cuerpoDatos">
                            <div class="nofixedX" id="cargarDatosLotePM2">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="VentanaModalUsuario" class="VentanaModal">
            <div id="handle5"><label id="TituloMatch"><%out.println(po.getProperty("etiqueta.LimitarAmbitoValor_US"));%></label><div class="BotonCerrar_Matc" id="OCULUsuario"><label >X</label></div></div>
            <div class="PanelBntMatch"><button><%out.println(po.getProperty("etiqueta.GralRestriciones"));%></button><hr></div>
