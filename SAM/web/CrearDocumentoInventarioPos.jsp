<%-- 
    Document   : CrearDocumentoInventarioPos
    Created on : 4/12/2017, 10:44:43 AM
    Author     : Panda
--%>
...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/StyleCrearDocInventario.css">
        <link rel="stylesheet" href="css/menu.css" media="screen">
        <script src="js/dom-drag.js"></script>
        <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        <script src="js/TimeEndSession.js" type="text/javascript"></script>
        <script src="js/CrearDocumentoInventario.js"></script>
        <title>Crear documento de inventario: Posiciones nuevas</title>
    </head>
    <body>
        <div id="main-header">
            <hr>
            ...
            <div class="titulo"><h1>Crear documento de inventario: Posiciones nuevas</h1></div>
        </div>
        <div class="contenido">
            <section class="bkSubSec">
                <section class="bkTop">
                    <label>Centro</label>
                    <input type="text" class="bxsmall" id="bxCentro" style="text-transform: uppercase;" readonly/>
                    <hr>
                    <label>Almacén</label>
                    <input type="text" class="bxsmall" id="bxAlmacen" style="text-transform: uppercase;" readonly/>
                    <hr>
                </section>
            </section>
...
//                        document.getElementById('guardar').disabled = true;
    ...
    <script language="javascript">
        function back() {
            window.location.href = "DocumentoInventario.jsp";
        }
    </script>
