 ...
 * @author JaroMX
 */
public class ACC_Solped_posiciones2 {
        Conexion cnx = new Conexion();
    PreparedStatement ps = null;
    Statement st = null;
    ResultSet rs = null;
    String query;
    private static ACC_Solped_posiciones2 Instance = null;

    public static ACC_Solped_posiciones2 ObtenerInstancia() {
        if (Instance == null) {
            Instance = new ACC_Solped_posiciones2();
        }
        return Instance;
    } 
