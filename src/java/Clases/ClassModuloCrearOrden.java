...
public class ClassModuloCrearOrden {

    int c;
    int d;

    public String imprimirTablaOperaciones() {
        String html;
    ...
    public String imprimirTablaComponentes() {
        String html;
    ...
    public String imprimirTablaServicios() {
        String html;
    ...
    public String imprimirTablaTextosDescri() {
        String html;
    ...
    public String imprimirTablaMateriales() {
        String html;
    ...
    public String imprimirTablaCabLotInsp() {
        String html;
    ...
    public String imprimirTablaPosLotInsp() {
        String html;
