 ...
 *
 */
@WebServlet(name = "peticionModuloHojaRuta", urlPatterns = {"/peticionModuloHojaRuta"})
public class peticionModuloHojaRuta extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (Accion) {
                ...
                case "CargarDatosHojaRuta":
                    ArrayList<hojas_de_ruta> hr = ACC_HojasRuta.ObtenerInstancia().ConsultaVisualizarHR(Equipo, Centros, Altern);
                    if (hr.size() > 0) {
