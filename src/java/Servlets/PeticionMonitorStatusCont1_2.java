 ...
 */
@WebServlet(name = "PeticionMonitorStatusCont1_2", urlPatterns = {"/PeticionMonitorStatusCont1_2"})
public class PeticionMonitorStatusCont1_2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            LinkedList<MonitorStatus> Msc = ACC_MonitorStatus.ObtenerInstancia().CARgarSEgTabla(Centro,Equipo);
            if(Tabla == null || Tabla == "")
            {
...
"                            <tbody id=\"jaja2\">\n");
                    ...
                    {
                        if (Msc.get(c).getDoc_medicion().equals("")){ input = "<input type=\"radio\" name=\"monitor2\" "
                        ...
                        else{ input = "<input type=\"radio\" name=\"monitor2\" "
                        + "value=\""+ Msc.get(c).getJerarquia() +"," + Msc.get(c).getNivel() + ","
                        + "" + Msc.get(c).getElem_ref_pmps() + "," + Msc.get(c).getEquipo() + ","
                        + "" + Msc.get(c).getDen_objtec()+ "," + Msc.get(c).getPunto_medida()+ ","
                        + "" + Msc.get(c).getDoc_medicion()+ " ," + Msc.get(c).getUlt_med_anexada()+ ","
