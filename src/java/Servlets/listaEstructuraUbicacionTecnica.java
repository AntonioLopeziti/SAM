 ...
 */
@WebServlet(name = "listaEstructuraUbicacionTecnica", urlPatterns = {"/listaEstructuraUbicacionTecnica"})
public class listaEstructuraUbicacionTecnica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (ub == null || ub == "") {
                out.println("<table>");
                out.println("<tr>");
                out.println("<td><b>Estr.</b></td>");
                out.println("<td><b>Texto ind-estructura para ubica.técnica</b></td>");
                out.println("<td><b>Máscara Codificación</b></td>");
                out.println("</tr>");
