 ...
 * @author JaroMX
 */
@WebServlet(name = "archivosMovimiento101", urlPatterns = {"/archivosMovimiento101"})
public class archivosMovimiento101 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            File evc = new File("C:\\Archivos\\DMS\\" + centro + "\\EVC\\");
            evc.mkdir();
...
//            folder.mkdir();
            try {
                ...
                for (int i = 0; i < items.size(); i++) {
                    ...
                    if (!item.isFormField()) {
                        ruta = "C:\\Archivos\\DMS\\" + centro + "\\EVC\\" + item.getName();
